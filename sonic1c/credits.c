...
ROMFUNC(rom_57DA) {
  ...
  DEF_ROMLOC(583E) : move_tomem_8(0xFFFFFF8A, 0xFFFFD080); // MOVE.B
                                                           // #$8A,$D080
...
ROMFUNC(rom_58A6) {
  ...
  DEF_ROMLOC(58B4) : move_tomem_16(D0, v_zone);     // MOVE.W	D0,$FE10
  ...
  DEF_ROMLOC(58D0) : move_tomem_8(0x3, v_lives);     // MOVE.B	#$03,$FE12
...
ROMFUNC(rom_59BC);
ROMFUNC(rom_59B8) {
  DEF_ROMLOC(59B8) : game_state = rom_59BC;
...
ROMFUNC(rom_59C6) {
  ...
  DEF_ROMLOC(59D2) : and_tomem_8(0xFFFFFF80, 0xFFFFF605); // ANDI.B
                                                          // #$80,$F605
...
ROMFUNC(rom_5A0C) {
  ...
  DEF_ROMLOC(5A44) : move_tomem_8(0xFFFFFF8A, 0xFFFFD0C0); // MOVE.B
                                                           // #$8A,$D0C0
...
ROMFUNC(rom_5AE8) {
  ...
  DEF_ROMLOC(5AF4)
      : move_tomem_8(OBJ_TRYCHAOS,
                     A1 + offsetof(object, id));      // MOVE.B	#$8C,(A1)
...
ROMFUNC(rom_5B74) {
  ...
  DEF_ROMLOC(5BAC) : move_toreg_8(read_8(A0 + 0x3C), &D4);  // MOVE.B
                                                            // 60(A0),D4
  ...
  DEF_ROMLOC(5BB8) : add_toreg_16(read_16(A0 + 0x38), &D1); // ADD.W
                                                            // 56(A0),D1
  DEF_ROMLOC(5BBC)
