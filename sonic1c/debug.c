...
ROMFUNC(rom_1D6E6) {
  ...
  DEF_ROMLOC(1D6E8) : move_toreg_8(read_8(0xFFFFFE08), &D0);
...
ROMFUNC(rom_1D6F8) {
  ...
  DEF_ROMLOC(1D70E) : move_tomem_16(0x720, 0xFFFFF726); // MOVE.W
                                                        // #$0720,$F726
  DEF_ROMLOC(1D714) : and_tomem_16(0x7FF, 0xFFFFD00C);  // ANDI.W
                                                        // #$07FF,$D00C
  DEF_ROMLOC(1D71A) : and_tomem_16(0x7FF, 0xFFFFF704);  // ANDI.W
                                                        // #$07FF,$F704
  DEF_ROMLOC(1D720) : and_tomem_16(0x3FF, 0xFFFFF70C);  // ANDI.W
                                                        // #$03FF,$F70C
  ...
  DEF_ROMLOC(1D75E)
      : cmp_toreg_8(read_8(0xFFFFFE06), &D6);        // CMP.B	$FE06,D6
...
ROMFUNC(rom_1D7A2) {
  ...
  DEF_ROMLOC(1D7DE)
      : move_tomem_8(0xFFFFFFFF, 0xFFFFFE0B); // MOVE.B	#$FF,$FE0B
  DEF_ROMLOC(1D7E4)
  ...
  DEF_ROMLOC(1D8CC) : move_tomem_16(0x780, 0xFFFFD002); // MOVE.W
                                                        // #$0780,$D002
  ...
  DEF_ROMLOC(1D8F6) : move_tomem_16(0x40, 0xFFFFF782); // MOVE.W
                                                       // #$0040,$F782
  DEF_ROMLOC(1D8FC)
      : move_tomem_32(0x21CF4, 0xFFFFD004); // MOVE.L	#$00021CF4,$D004
  DEF_ROMLOC(1D904) : move_tomem_16(0x780, 0xFFFFD002); // MOVE.W
                                                        // #$0780,$D002
