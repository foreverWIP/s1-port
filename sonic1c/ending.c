...
ROMFUNC(rom_50FE) {
  ...
  DEF_ROMLOC(5204) : move_tomem_16(0x400, 0xFFFFF602); // MOVE.W
                                                       // #$0400,$F602
  DEF_ROMLOC(520A)
  ...
  DEF_ROMLOC(5268) : move_tomem_16(0x708, 0xFFFFF614); // MOVE.W
                                                       // #$0708,$F614
  DEF_ROMLOC(526E) : move_tomem_8(0x18, 0xFFFFF62A);   // MOVE.B	#$18,$F62A
  DEF_ROMLOC(5274) : game_state = rom_5278; rom_29A0();                       // BSR.W	$29A0
}
ROMFUNC(rom_5278) {
  DEF_ROMLOC(5278)
      : move_toreg_16(read_16(0xFFFFF60C), &D0);      // MOVE.W	$F60C,D0
...
ROMFUNC(rom_5294);
ROMFUNC(rom_5290) {
  DEF_ROMLOC(5290) : game_state = rom_5294; rom_13A0();                     // BSR.W	$13A0
}
ROMFUNC(rom_5294) {
...
ROMFUNC(rom_529E) {
  ...
  DEF_ROMLOC(52EA) : if (CCR_EQ) {rom_5290();return;}       // BEQ.W	$5290
...
ROMFUNC(rom_5300);
ROMFUNC(rom_52FC) {
  DEF_ROMLOC(52FC) : game_state = rom_5300; rom_13A0();                        // BSR.W	$13A0
}
ROMFUNC(rom_5300) {
  DEF_ROMLOC(5300) : move_tomem_8(0x18, 0xFFFFF62A);    // MOVE.B	#$18,$F62A
  DEF_ROMLOC(5306) : game_state = rom_530A; rom_29A0();                        // BSR.W	$29A0
}
ROMFUNC(rom_530A) {
  ...
  DEF_ROMLOC(534C) : move_tomem_16(0x2E2F, 0xFFFFA480); // MOVE.W
                                                        // #$2E2F,$A480
...
ROMFUNC(rom_537C) {
  DEF_ROMLOC(537C)
      : move_toreg_8(read_8(0xFFFFF7D7), &D0);         // MOVE.B	$F7D7,D0
  ...
  DEF_ROMLOC(5394) : move_tomem_16(0x800, 0xFFFFF602); // MOVE.W
                                                       // #$0800,$F602
  ...
  DEF_ROMLOC(53C6) : move_tomem_16(0x505, 0xFFFFD01C); // MOVE.W
                                                       // #$0505,$D01C
  ...
  DEF_ROMLOC(53E2)
      : move_tomem_8(0xFFFFFF87, 0xFFFFD000); // MOVE.B	#$87,$D000
