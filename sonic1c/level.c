...
ROMFUNC(rom_3942) {
  ...
  DEF_ROMLOC(39B8) : move_tomem_16(0x120, 0xFFFFD7C8); // MOVE.W
                                                       // #$0120,$D7C8
...
ROMFUNC(rom_3A9A) {
  ...
  DEF_ROMLOC(3A9E) : move_tomem_16(0x202F, 0xFFFFF626); // MOVE.W
                                                        // #$202F,$F626
...
ROMFUNC(rom_3AE2) {
  ...
  DEF_ROMLOC(3AE8) : game_state = rom_3AEC; rom_29A0();                    // BSR.W	$29A0
}
ROMFUNC(rom_3AEC) {
  ...
  game_state = rom_3B9E; rom_3B94(); // Detected flow into next function
}
ROMFUNC(rom_3B94) {
