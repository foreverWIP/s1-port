...
ROMFUNC(rom_97A8) {
  ...
  DEF_ROMLOC(97DA)
      : move_toreg_8(read_8(A0 + 0x30), &D0);       // MOVE.B
                                                    // 48(A0),D0
  ...
  DEF_ROMLOC(97FE) : queue_sprite();                // BRA.W	$DC92
}
ROMFUNC(rom_9802) {
...
ROMFUNC(rom_98A2) {
  ...
  DEF_ROMLOC(98BA) : queue_sprite(); // BRA.W	$DC92
}
ROMFUNC(rom_98BE) {
  ...
  DEF_ROMLOC(98DA) : queue_sprite();               // BRA.W	$DC92
}
ROMFUNC(rom_98DE) {
