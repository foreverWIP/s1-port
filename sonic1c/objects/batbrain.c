...
ROMFUNC(rom_10734) {
	...
	DEF_ROMLOC(10736): move_toreg_8(read_8(A0 + 0x24), &D0); switchindex = D0 / 2; // MOVE.B	36(A0),D0
	...
	DEF_ROMLOC(1073E):
		switch (switchindex) {
			case 0: rom_10746(); break;
			case 1: rom_10776(); break;
		}
}
ROMFUNC(rom_10746) {
...
ROMFUNC(rom_10776) {
	...
	DEF_ROMLOC(10778): move_toreg_8(read_8(A0 + 0x25), &D0); switchindex = D0 / 2; // MOVE.B	37(A0),D0
	...
	DEF_ROMLOC(10780):
		switch (switchindex) {
			case 0: goto rom_1079A; break;
			case 1: goto rom_107D6; break;
			case 2: goto rom_10818; break;
			case 3: goto rom_10854; break;
		}
	...
	DEF_ROMLOC(107A4): move_toreg_16(read_16(0xFFFFD00C), &D0); // MOVE.W	$D00C,D0
	DEF_ROMLOC(107A8): move_tomem_16(D0, A0 + 0x36); // MOVE.W	D0,54(A0)
	DEF_ROMLOC(107AC): sub_toreg_16(read_16(A0 + 0xC), &D0); // SUB.W	12(A0),D0
	...
	DEF_ROMLOC(107BE): move_toreg_8(read_8(0xFFFFFE0F), &D0); // MOVE.B	$FE0F,D0
	...
	DEF_ROMLOC(107E8): move_toreg_16(read_16(A0 + 0x36), &D0); // MOVE.W	54(A0),D0
	DEF_ROMLOC(107EC): sub_toreg_16(read_16(A0 + 0xC), &D0); // SUB.W	12(A0),D0
	...
	DEF_ROMLOC(10812): if (CCR_PL) {rom_DCCE();return;} // BPL.W	$DCCE
	DEF_ROMLOC(10816): return; // RTS
	DEF_ROMLOC(10818): move_toreg_8(read_8(0xFFFFFE0F), &D0); // MOVE.B	$FE0F,D0
	...
	DEF_ROMLOC(10826): rom_1394(); // JSR	$00001394
	DEF_ROMLOC(1082C): rom_DC6C(); // BSR.W	$DC6C
	DEF_ROMLOC(10830): move_toreg_16(read_16(0xFFFFD008), &D0); // MOVE.W	$D008,D0
	DEF_ROMLOC(10834): sub_toreg_16(read_16(A0 + 0x8), &D0); // SUB.W	8(A0),D0
	...
	DEF_ROMLOC(10842): move_toreg_8(read_8(0xFFFFFE0F), &D0); // MOVE.B	$FE0F,D0
	...
	DEF_ROMLOC(1086A): and_tomem_16(0xFFFFFFF8, A0 + 0x8); // ANDI.W	#$FFF8,8(A0)
...
ROMFUNC(rom_10882) {
	...
	DEF_ROMLOC(1088C): move_toreg_16(read_16(0xFFFFD008), &D0); // MOVE.W	$D008,D0
