...
ROMFUNC(rom_17EAC) {
  ...
  DEF_ROMLOC(17EAE) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(17EB2)
      : move_toreg_16(read_16(0x17EBA + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(17EB6): goto rom_17EBA + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(17EB6) : switch (switchindex) {
  case 0:
    rom_17EC8();
    break;
  case 1:
...
ROMFUNC(rom_17EC2) {
  ...
  DEF_ROMLOC(17F1A) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_17ED4; // DBF.W	D1,$17ED4
  DEF_ROMLOC(17F1E)
  ...
  DEF_ROMLOC(17F38) : move_toreg_8(read_8(A0 + 0x25), &D0);
  switchindex = D0 / 2; // MOVE.B	37(A0),D0
  DEF_ROMLOC(17F3C)
      : move_toreg_16(read_16(0x17F68 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	42(PC,D0),D1
  // DEF_ROMLOC(17F40): rom_17F68 + (s16)(D1 & 0xffff)(); // JSR
  // 38(PC,D1)
  DEF_ROMLOC(17F40) : switch (switchindex) {
  case 0:
    rom_17F76();
    break;
  case 1:
  ...
  DEF_ROMLOC(17F4A) : animate_sprite();                  // JSR	$0000ADA2
  DEF_ROMLOC(17F50) : move_toreg_8(read_8(A0 + 0x22), &D0); // MOVE.B
                                                            // 34(A0),D0
...
ROMFUNC(rom_17F76) {
  ...
  DEF_ROMLOC(17F80)
      : cmp_tomem_16(0x338, A0 + 0x38); // CMPI.W	#$0338,56(A0)
  DEF_ROMLOC(17F86) : if (!CCR_EQ) {
    rom_17F92();
    return;
  }                                                  // BNE.B	$17F92
...
ROMFUNC(rom_17F92) {
  ...
  DEF_ROMLOC(17FD0) : move_toreg_16(SFX_HITBOSS, &D0);       // MOVE.W	#$00AC,D0
  DEF_ROMLOC(17FD4) : play_sound_special();           // JSR	$00001394
...
ROMFUNC(rom_18050) {
  DEF_ROMLOC(18050)
      : move_toreg_32(read_32(A0 + 0x30), &D2); // MOVE.L	48(A0),D2
  DEF_ROMLOC(18054)
      : move_toreg_32(read_32(A0 + 0x38), &D3); // MOVE.L	56(A0),D3
  DEF_ROMLOC(18058)
...
ROMFUNC(rom_18076) {
  ...
  DEF_ROMLOC(18086)
      : cmp_tomem_16(0x2A00, A0 + 0x30);           // CMPI.W
                                                   // #$2A00,48(A0)
...
ROMFUNC(rom_180C6) {
  ...
  DEF_ROMLOC(180D0)
      : move_tomem_16(0x3F, A0 + 0x3C); // MOVE.W	#$003F,60(A0)
  DEF_ROMLOC(180D6)
  ...
  DEF_ROMLOC(180E4)
      : move_tomem_16(0x7F, A0 + 0x3C);               // MOVE.W	#$007F,60(A0)
...
ROMFUNC(rom_18158) {
  ...
  DEF_ROMLOC(18190) : move_toreg_16(BGM_GHZ, &D0);      // MOVE.W	#$0081,D0
  DEF_ROMLOC(18194) : play_sound();                  // JSR	$0000138E
...
ROMFUNC(rom_181A2) {
  ...
  DEF_ROMLOC(181A8)
      : move_tomem_16(0xFFFFFFC0, A0 + 0x12); // MOVE.W	#$FFC0,18(A0)
  DEF_ROMLOC(181AE)
      : cmp_tomem_16(0x2AC0, 0xFFFFF72A);            // CMPI.W
                                                     // #$2AC0,$F72A
...
ROMFUNC(rom_181D0) {
  ...
  DEF_ROMLOC(181E0)
      : cmp_tomem_16(0x2A00, A1 + 0x30);            // CMPI.W
                                                    // #$2A00,48(A1)
...
ROMFUNC(rom_18256) {
  ...
  DEF_ROMLOC(18272) : animate_sprite();                   // JSR	$0000ADA2
  DEF_ROMLOC(18278) : move_toreg_8(read_8(A0 + 0x22), &D0); // MOVE.B
                                                            // 34(A0),D0
