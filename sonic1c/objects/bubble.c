...
ROMFUNC(rom_12D78) {
  ...
  DEF_ROMLOC(12D7A) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(12D7E)
      : move_toreg_16(read_16(0x12D86 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(12D82): goto rom_12D86 + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(12D82) : switch (switchindex) {
  case 0:
    rom_12D92();
    break;
  case 1:
...
ROMFUNC(rom_12D92) {
  ...
  DEF_ROMLOC(12DA4) : move_tomem_8(0xFFFFFF84, A0 + 0x1); // MOVE.B
                                                          // #$84,1(A0)
...
ROMFUNC(rom_12E0A) {
  ...
  DEF_ROMLOC(12E3A) : add_toreg_16(read_16(A0 + 0x30), &D0); // ADD.W
                                                             // 48(A0),D0
...
ROMFUNC(rom_12EE6) {
  ...
  DEF_ROMLOC(12EEC)
      : move_toreg_16(read_16(0xFFFFF646), &D0);            // MOVE.W	$F646,D0
  DEF_ROMLOC(12EF0) : cmp_toreg_16(read_16(A0 + 0xC), &D0); // CMP.W
                                                            // 12(A0),D0
  ...
  DEF_ROMLOC(13012)
      : move_toreg_16(read_16(0xFFFFF646), &D0);            // MOVE.W	$F646,D0
  DEF_ROMLOC(13016) : cmp_toreg_16(read_16(A0 + 0xC), &D0); // CMP.W
                                                            // 12(A0),D0
