...
ROMFUNC(rom_170BA) {
  ...
  DEF_ROMLOC(17148) : move_tomem_8(OBJ_CATERKILLER, A1 + offsetof(object, id)); // MOVE.B	#$78,0(A1)
...
ROMFUNC(rom_17354) {
  ...
  DEF_ROMLOC(17418) : cmp_tomem_8(OBJ_EXPLOSIONITEM, A1 + offsetof(object, id));  // CMPI.B	#$27,0(A1)
