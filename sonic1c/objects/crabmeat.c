...
ROMFUNC(rom_9BFA) {
  ...
  DEF_ROMLOC(9C48) : move_tomem_8(OBJ_CRABMEAT, A1 + offsetof(object, id));   // MOVE.B	#$1F,0(A1)
  ...
  DEF_ROMLOC(9C72) : move_tomem_8(OBJ_CRABMEAT, A1 + offsetof(object, id)); // MOVE.B	#$1F,0(A1)
