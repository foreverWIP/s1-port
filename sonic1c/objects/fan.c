...
ROMFUNC(rom_11BD0) {
  ...
  DEF_ROMLOC(11BD2) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(11BD6)
      : move_toreg_16(read_16(0x11BDE + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(11BDA): goto rom_11BDE + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(11BDA) : switch (switchindex) {
  case 0:
    rom_11BE2();
    break;
  case 1:
...
ROMFUNC(rom_11BE2) {
  ...
  DEF_ROMLOC(11BE6)
      : move_tomem_32(0x11CE4, A0 + 0x4); // MOVE.L	#$00011CE4,4(A0)
  DEF_ROMLOC(11BEE)
      : move_tomem_16(0x43A0, A0 + 0x2);             // MOVE.W
                                                     // #$43A0,2(A0)
...
ROMFUNC(rom_11C06) {
  ...
  DEF_ROMLOC(11CB8)
      : add_toreg_8(read_8(A0 + 0x1B), &D0);                 // ADD.B
                                                             // 27(A0),D0
  DEF_ROMLOC(11CBC) : move_tomem_8(D0, A0 + 0x1A);           // MOVE.B	D0,26(A0)
  DEF_ROMLOC(11CC0) : queue_sprite();                        // BSR.W	$DC92
