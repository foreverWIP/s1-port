...
ROMFUNC(rom_10B1A) {
  ...
  DEF_ROMLOC(10B20) : cmp_tomem_16(0x100, 0xFFFFFE10); // CMPI.W
                                                       // #$0100,$FE10
  ...
  DEF_ROMLOC(10B56) : cmp_tomem_16(0x100, 0xFFFFFE10); // CMPI.W
                                                       // #$0100,$FE10
