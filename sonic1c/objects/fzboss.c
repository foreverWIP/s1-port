...
ROMFUNC(rom_1A658) {
  ...
  DEF_ROMLOC(1A778) : move_tomem_16(0x25C0, A0 + 0x8); // MOVE.W
                                                       // #$25C0,8(A0)
...
ROMFUNC(rom_1A7E0) {
  ...
  DEF_ROMLOC(1A816) : move_tomem_16(0x100, A0 + 0x10); // MOVE.W
                                                       // #$0100,16(A0)
  DEF_ROMLOC(1A81C)
...
ROMFUNC(rom_1A82A) {
  ...
  DEF_ROMLOC(1A850) : move_tomem_16(0x400, A0 + 0x10); // MOVE.W
                                                       // #$0400,16(A0)
  DEF_ROMLOC(1A856)
  ...
  DEF_ROMLOC(1A860) : move_tomem_16(0x500, A0 + 0x10); // MOVE.W
                                                       // #$0500,16(A0)
  ...
  DEF_ROMLOC(1A8B0) : move_tomem_16(0x26A0, A0 + 0x8); // MOVE.W
                                                       // #$26A0,8(A0)
  DEF_ROMLOC(1A8B6) : move_tomem_16(0x240, A0 + 0x10); // MOVE.W
                                                       // #$0240,16(A0)
  DEF_ROMLOC(1A8BC)
...
ROMFUNC(rom_1A8C8) {
  ...
  DEF_ROMLOC(1A8FC)
      : or_toreg_16(read_16(A0 + 0x12), &D0); // OR.W	18(A0),D0
...
ROMFUNC(rom_1A91C) {
  DEF_ROMLOC(1A91C) : cmp_tomem_16(0x2700, 0xFFFFF72A); // CMPI.W
                                                        // #$2700,$F72A
...
ROMFUNC(rom_1A948) {
  ...
  DEF_ROMLOC(1A970) : move_tomem_16(0x180, A0 + 0x10); // MOVE.W
                                                       // #$0180,16(A0)
  DEF_ROMLOC(1A976)
...
ROMFUNC(rom_1A98A) {
  ...
  DEF_ROMLOC(1A9CC) : cmp_tomem_16(0x2790, 0xFFFFD008);  // CMPI.W
                                                         // #$2790,$D008
  ...
  DEF_ROMLOC(1A9EA) : move_tomem_16(0x100, 0xFFFFF602);  // MOVE.W
                                                         // #$0100,$F602
  DEF_ROMLOC(1A9F0) : cmp_tomem_16(0x27E0, 0xFFFFD008);  // CMPI.W
                                                         // #$27E0,$D008
  DEF_ROMLOC(1A9F6) : if (CCR_LT) goto rom_1A9FE;        // BLT.B	$1A9FE
  DEF_ROMLOC(1A9F8) : move_tomem_16(0x27E0, 0xFFFFD008); // MOVE.W
                                                         // #$27E0,$D008
...
ROMFUNC(rom_1AA5C) {
  ...
  DEF_ROMLOC(1AA6C) : and_tomem_8(0xFFFFFFFC, A0 + 0x1); // ANDI.B
                                                         // #$FC,1(A0)
