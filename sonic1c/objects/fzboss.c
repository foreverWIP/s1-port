...
ROMFUNC(rom_1A57E) {
  ...
  DEF_ROMLOC(1A594) : move_tomem_8(OBJ_BOSSFINAL, A1 + offsetof(object, id)); // MOVE.B	#$85,(A1)
  DEF_ROMLOC(1A598)
  ...
  DEF_ROMLOC(1A5DC) : move_tomem_8(OBJ_BOSSPLASMA, A1 + offsetof(object, id));         // MOVE.B	#$86,(A1)
  ...
  DEF_ROMLOC(1A5F8) : move_tomem_8(OBJ_EGGMANCYLINDER, A1 + offsetof(object, id));         // MOVE.B	#$84,(A1)
...
ROMFUNC(rom_1A658) {
  ...
  DEF_ROMLOC(1A6B6) : move_toreg_16(SFX_RUMBLING, &D0);      // MOVE.W	#$00B7,D0
  ...
  DEF_ROMLOC(1A72E) : move_toreg_16(SFX_HITBOSS, &D0);      // MOVE.W	#$00AC,D0
...
ROMFUNC(rom_1A7D6) {
  DEF_ROMLOC(1A7D6) : move_toreg_16(SFX_ELECTRIC, &D0); // MOVE.W	#$00B1,D0
...
ROMFUNC(rom_1A98A) {
  ...
  DEF_ROMLOC(1A9A8) : move_toreg_16(SFX_HITBOSS, &D0);       // MOVE.W	#$00AC,D0
