...
ROMFUNC(rom_182A8) {
  ...
  DEF_ROMLOC(182AC) : move_tomem_16(0x4080, A0 + 0x26); // MOVE.W
                                                        // #$4080,38(A0)
  DEF_ROMLOC(182B2)
  ...
  DEF_ROMLOC(18344) : move_tomem_16(0x43AA, A1 + 0x2); // MOVE.W
                                                       // #$43AA,2(A1)
