...
ROMFUNC(rom_CC00) {
	...
	DEF_ROMLOC(CC02): move_toreg_8(read_8(A0 + 0x24), &D0); switchindex = D0 / 2; // MOVE.B	36(A0),D0
	...
	DEF_ROMLOC(CC0A):
		switch (switchindex) {
			case 0: rom_CC20(); break;
			case 1: rom_CC78(); break;
			case 2: rom_CCC2(); break;
			case 3: rom_CCD0(); break;
			case 4: rom_CCC2(); break;
			case 5: rom_CD3C(); break;
			case 6: rom_CCC2(); break;
			case 7: rom_CDB2(); break;
			case 8: rom_CDF4(); break;
		}
}
ROMFUNC(rom_CC20) {
...
ROMFUNC(rom_CCD0) {
	...
	DEF_ROMLOC(CD36): {rom_1394();return;} // JMP	$00001394
}
ROMFUNC(rom_CD3C) {
...
ROMFUNC(rom_CDB2) {
	...
	DEF_ROMLOC(CDBC): if (CCR_EQ) {rom_CDD8();return;} // BEQ.B	$CDD8
	DEF_ROMLOC(CDBE): if (CCR_GE) {rom_CDC2();return;} // BGE.B	$CDC2
...
ROMFUNC(rom_CDD8) {
	...
	DEF_ROMLOC(CDDE): if (!CCR_EQ) {rom_DCCE();return;} // BNE.W	$DCCE
	...
	DEF_ROMLOC(CDEE): {rom_138E();return;} // JMP	$0000138E
}
ROMFUNC(rom_CDF4) {
	...
	DEF_ROMLOC(CDFE): if (CCR_EQ) {rom_DCCE();return;} // BEQ.W	$DCCE
