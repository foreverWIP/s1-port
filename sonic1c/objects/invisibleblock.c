...
ROMFUNC(rom_11AEE) {
  ...
  DEF_ROMLOC(11AF0) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(11AF4)
      : move_toreg_16(read_16(0x11AFC + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(11AF8): goto rom_11AFC + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(11AF8) : switch (switchindex) {
  case 0:
    rom_11B00();
    break;
  case 1:
...
ROMFUNC(rom_11B00) {
  ...
  DEF_ROMLOC(11B04)
      : move_tomem_32(0x11B8A, A0 + 0x4); // MOVE.L	#$00011B8A,4(A0)
  DEF_ROMLOC(11B0C)
      : move_tomem_16(0xFFFF8680, A0 + 0x2);     // MOVE.W	#$8680,2(A0)
...
ROMFUNC(rom_11B38) {
  ...
  DEF_ROMLOC(11B4A) : move_toreg_8(read_8(A0 + 0x16), &D2); // MOVE.B
                                                            // 22(A0),D2
