...
ROMFUNC(rom_175F6) {
  ...
  DEF_ROMLOC(17620) : move_toreg_8(read_8(A0 + 0x23), &D0); // MOVE.B
                                                            // 35(A0),D0
  DEF_ROMLOC(17624)
      : bclr_tomem_8(0x7,
  ...
  DEF_ROMLOC(1763A) : move_toreg_8(read_8(A0 + 0x28), &D2); // MOVE.B
                                                            // 40(A0),D2
...
ROMFUNC(rom_1765A) {
  ...
  DEF_ROMLOC(17672) : move_toreg_8(read_8(A0 + 0x28), &D2); // MOVE.B
                                                            // 40(A0),D2
  ...
  DEF_ROMLOC(17684) : move_toreg_8(read_8(A0 + 0x23), &D0); // MOVE.B
                                                            // 35(A0),D0
  DEF_ROMLOC(17688)
      : bset_tomem_8(0x0,
                     (s32)A2 + (s8)0x2 + (s16)D0);  // BSET.B	#$00,2(A2,D0)
  ...
  DEF_ROMLOC(176C6) : rom_1394();                   // JSR	$00001394
  ...
  DEF_ROMLOC(176D8) : move_tomem_8(0x79, A1 + 0x0); // MOVE.B	#$79,0(A1)
  ...
  DEF_ROMLOC(17732) : move_toreg_8(read_8(A0 + 0x23), &D0); // MOVE.B
                                                            // 35(A0),D0
  DEF_ROMLOC(17736)
      : bset_tomem_8(0x0,
                     (s32)A2 + (s8)0x2 + (s16)D0); // BSET.B	#$00,2(A2,D0)
...
ROMFUNC(rom_17740) {
  ...
  DEF_ROMLOC(17764) : swap_reg_16(&D1);             // SWAP.W	D1
  DEF_ROMLOC(17766)
  ...
  DEF_ROMLOC(17772) : swap_reg_16(&D0);            // SWAP.W	D0
  DEF_ROMLOC(17774)
