...
ROMFUNC(rom_18902) {
  DEF_ROMLOC(18902)
      : cmp_tomem_16(0x2030, v_limitright2);            // CMPI.W
                                                        // #$2030,$F72A
  DEF_ROMLOC(18908) : if (CCR_CC) goto rom_18910;       // BCC.B	$18910
  DEF_ROMLOC(1890A) : add_tomem_16(0x2, v_limitright2); // ADDQ.W
                                                        // #$02,$F72A
