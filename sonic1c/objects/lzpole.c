...
ROMFUNC(rom_118DA) {
  ...
  DEF_ROMLOC(118DC) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(118E0)
      : move_toreg_16(read_16(0x118E8 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(118E4): goto rom_118E8 + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(118E4) : switch (switchindex) {
  case 0:
    rom_118EE();
    break;
  case 1:
...
ROMFUNC(rom_118EE) {
  ...
  DEF_ROMLOC(118F2)
      : move_tomem_32(0x119F6, A0 + 0x4); // MOVE.L	#$000119F6,4(A0)
  DEF_ROMLOC(118FA) : move_tomem_16(0x43DE, A0 + 0x2); // MOVE.W
                                                       // #$43DE,2(A0)
  ...
  DEF_ROMLOC(11912)
      : move_tomem_8(0xFFFFFFE1, A0 + 0x20);   // MOVE.B	#$E1,32(A0)
