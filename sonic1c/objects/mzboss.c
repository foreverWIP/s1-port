...
ROMFUNC(rom_18AEE) {
  ...
  DEF_ROMLOC(18B14)
      : move_tomem_8(0x28, A0 + 0x3E); // MOVE.B	#$28,62(A0)
  DEF_ROMLOC(18B1A)
...
ROMFUNC(rom_18B7A) {
  ...
  DEF_ROMLOC(18BCC)
      : move_tomem_8(OBJ_LAVABALL,
                     A1 + offsetof(object, id));      // MOVE.B	#$14,0(A1)
  ...
  DEF_ROMLOC(18BE8) : SWAPWORDS(D0);                  // SWAP.W	D0
...
ROMFUNC(rom_18D32) {
  ...
  DEF_ROMLOC(18D3E)
      : cmp_tomem_16(0x1960, v_limitright2);            // CMPI.W
                                                        // #$1960,$F72A
  DEF_ROMLOC(18D44) : if (CCR_CC) goto rom_18D4C;       // BCC.B	$18D4C
  DEF_ROMLOC(18D46) : add_tomem_16(0x2, v_limitright2); // ADDQ.W
                                                        // #$02,$F72A
