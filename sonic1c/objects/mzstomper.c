...
ROMFUNC(rom_BD3C) {
  ...
  DEF_ROMLOC(BD82) : move_tomem_8(OBJ_CHAINSTOMP, A1 + offsetof(object, id)); // MOVE.B	#$31,0(A1)
  DEF_ROMLOC(BD88)
  ...
  DEF_ROMLOC(BDD8) : move_toreg_8(read_8(A0 + 0x28), &D0); // MOVE.B
                                                           // 40(A0),D0
  ...
  DEF_ROMLOC(BE04) : move_toreg_8(read_8(A0 + 0x28), &D0); // MOVE.B
                                                           // 40(A0),D0
...
ROMFUNC(rom_BE22) {
  ...
  DEF_ROMLOC(BE2E) : move_toreg_8(read_8(A0 + 0x19), &D1);  // MOVE.B
                                                            // 25(A0),D1
...
ROMFUNC(rom_BE88) {
  ...
  DEF_ROMLOC(BE8E) : move_toreg_8(read_8(A1 + 0x32), &D0); // MOVE.B
                                                           // 50(A1),D0
  DEF_ROMLOC(BE92)
...
ROMFUNC(rom_BEBE) {
  u8 switchindex = 0;
  DEF_ROMLOC(BEBE) : move_toreg_8(read_8(A0 + 0x28), &D0); // MOVE.B
                                                           // 40(A0),D0
...
ROMFUNC(rom_BF6A) {
  ...
  DEF_ROMLOC(BF6C) : move_toreg_8(read_8(A0 + 0x32), &D0); // MOVE.B
                                                           // 50(A0),D0
  DEF_ROMLOC(BF70)
      : add_toreg_16(read_16(A0 + 0x30), &D0);    // ADD.W	48(A0),D0
...
ROMFUNC(rom_BEDE) {
  ...
  DEF_ROMLOC(BEE4) : move_toreg_8(read_8(A0 + 0x3A), &D0); // MOVE.B
                                                           // 58(A0),D0
  DEF_ROMLOC(BEE8)
  ...
  DEF_ROMLOC(BF36) : cmp_toreg_16(read_16(A0 + 0x32), &D1); // CMP.W
                                                            // 50(A0),D1
  ...
  DEF_ROMLOC(BF4A) : cmp_toreg_16(read_16(A0 + 0x32), &D1); // CMP.W
                                                            // 50(A0),D1
...
ROMFUNC(rom_BF7A) {
  ...
  DEF_ROMLOC(BFDA) : cmp_toreg_16(read_16(A0 + 0x32), &D1); // CMP.W
                                                            // 50(A0),D1
