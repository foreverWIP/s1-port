...
ROMFUNC(rom_BD3C) {
  ...
  DEF_ROMLOC(BD82)
      : move_tomem_8(OBJ_CHAINSTOMP,
                     A1 + offsetof(object, id)); // MOVE.B	#$31,0(A1)
  DEF_ROMLOC(BD88)
...
ROMFUNC(rom_BEDE) {
  ...
  DEF_ROMLOC(BF12) : move_toreg_16(SFX_CHAINRISE, &D0);     // MOVE.W
                                                            // #$00C7,D0
  ...
  DEF_ROMLOC(BF60)
      : move_toreg_16(SFX_CHAINSTOMP, &D0); // MOVE.W	#$00BD,D0
...
ROMFUNC(rom_BF7A) {
  ...
  DEF_ROMLOC(BF9C) : move_toreg_16(SFX_CHAINRISE, &D0);     // MOVE.W
                                                            // #$00C7,D0
