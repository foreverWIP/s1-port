...
ROMFUNC(rom_A9DC) {
  ...
  DEF_ROMLOC(AAB0)
      : cmp_tomem_16(0xC, 0xFFFFFE14);          // CMPI.W	#$000C,$FE14
...
ROMFUNC(rom_AB18) {
  ...
  DEF_ROMLOC(AB30) : move_toreg_8(read_8(A1 + 0x16), &D3); // MOVE.B
                                                           // 22(A1),D3
  ...
  DEF_ROMLOC(AB76) : move_toreg_8(read_8(A0 + 0x19), &D1); // MOVE.B
                                                           // 25(A0),D1
