...
ROMFUNC(rom_A9DC) {
  ...
  DEF_ROMLOC(AA14) : move_toreg_16(BGM_EXTRALIFE, &D0); // MOVE.W
                                                        // #$0088,D0
  DEF_ROMLOC(AA18) : {
    play_sound();
    return;
  ...
  DEF_ROMLOC(AA2A)
      : move_tomem_16(0x4B0, 0xFFFFD034); // MOVE.W
                                          // #$04B0,$D034
  DEF_ROMLOC(AA30)
      : move_tomem_16(0xC00, 0xFFFFF760); // MOVE.W
                                          // #$0C00,$F760
  DEF_ROMLOC(AA36)
  ...
  DEF_ROMLOC(AA42)
      : move_toreg_16(COMSFX_SPEEDUP, &D0); // MOVE.W	#$00E2,D0
  DEF_ROMLOC(AA46) : {
    play_sound();
    return;
  } // JMP	$0000138E
  ...
  DEF_ROMLOC(AA74)
      : move_tomem_16(0x4B0, 0xFFFFD032);            // MOVE.W
                                                     // #$04B0,$D032
  ...
  DEF_ROMLOC(AAB8)
      : move_toreg_16(BGM_INVINCIBLE, &D0); // MOVE.W	#$0087,D0
  DEF_ROMLOC(AABC) : {
    play_sound();
    return;
  } // JMP	$0000138E
...
ROMFUNC(rom_AB18) {
  ...
  DEF_ROMLOC(AB58) : tst_mem_16(v_debuguse);       // TST.W	$FE08
