...
ROMFUNC(rom_A34C) {
  ...
  DEF_ROMLOC(A3B4)
      : move_tomem_8(0xFFFFFFFF, v_ani3_time);     // MOVE.B	#$FF,$FEC6
  ...
  DEF_ROMLOC(A402)
      : move_toreg_16(SFX_RINGLOSS, &D0);  // MOVE.W
                                           // #$00C6,D0
...
ROMFUNC(rom_A40C) {
  DEF_ROMLOC(A40C)
      : move_tomem_8(read_8(v_ani3_frame),
                     A0 + 0x1A);                    // MOVE.B	$FEC7,26(A0)
  ...
  DEF_ROMLOC(A446) : tst_mem_8(v_ani3_time);      // TST.B	$FEC6
