...
ROMFUNC(rom_A1DC) {
  ...
  DEF_ROMLOC(A1E2) : move_toreg_8(read_8(A0 + 0x23), &D0); // MOVE.B
                                                           // 35(A0),D0
  DEF_ROMLOC(A1E6)
...
ROMFUNC(rom_A2BC) {
  ...
  DEF_ROMLOC(A2D6) : move_toreg_8(read_8(A0 + 0x23), &D0); // MOVE.B
                                                           // 35(A0),D0
  DEF_ROMLOC(A2DA) : move_toreg_8(read_8(A0 + 0x34), &D1); // MOVE.B
                                                           // 52(A0),D1
  DEF_ROMLOC(A2DE)
      : bset_tomem_8(D1,
