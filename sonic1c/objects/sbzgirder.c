...
ROMFUNC(rom_16C92) {
  ...
  DEF_ROMLOC(16C94) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(16C98)
      : move_toreg_16(read_16(0x16CA0 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(16C9C): goto rom_16CA0 + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(16C9C) : switch (switchindex) {
  case 0:
    rom_16CA4();
    break;
  case 1:
...
ROMFUNC(rom_16CA4) {
  ...
  DEF_ROMLOC(16CA8)
      : move_tomem_32(0x16D90, A0 + 0x4); // MOVE.L	#$00016D90,4(A0)
  DEF_ROMLOC(16CB0)
      : move_tomem_16(0x42F0, A0 + 0x2);            // MOVE.W
                                                    // #$42F0,2(A0)
  DEF_ROMLOC(16CB6) : or_tomem_8(0x4, A0 + 0x1);    // ORI.B	#$04,1(A0)
  DEF_ROMLOC(16CBC) : move_tomem_8(0x4, A0 + 0x18); // MOVE.B	#$04,24(A0)
  DEF_ROMLOC(16CC2)
      : move_tomem_8(0x60, A0 + 0x19); // MOVE.B	#$60,25(A0)
  DEF_ROMLOC(16CC8)
      : move_tomem_8(0x18, A0 + 0x16); // MOVE.B	#$18,22(A0)
  DEF_ROMLOC(16CCE)
...
ROMFUNC(rom_16D46) {
  ...
  DEF_ROMLOC(16D58)
      : move_tomem_16(read_16((A1 += 2, A1 - 2)),
                      A0 + 0x10); // MOVE.W	(A1)+,16(A0)
  DEF_ROMLOC(16D5C)
      : move_tomem_16(read_16((A1 += 2, A1 - 2)),
                      A0 + 0x12); // MOVE.W	(A1)+,18(A0)
  DEF_ROMLOC(16D60)
      : move_tomem_16(read_16((A1 += 2, A1 - 2)),
