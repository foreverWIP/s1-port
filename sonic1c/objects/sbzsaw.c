...
ROMFUNC(rom_160F6) {
  ...
  DEF_ROMLOC(16102) : move_tomem_16(0x43B5, A0 + 0x2); // MOVE.W
                                                       // #$43B5,2(A0)
...
ROMFUNC(rom_1617C) {
  ...
  DEF_ROMLOC(161C2) : rom_1394();                  // JSR	$00001394
...
ROMFUNC(rom_161CA) {
  ...
  DEF_ROMLOC(16212) : rom_1394();                  // JSR	$00001394
...
ROMFUNC(rom_1628E) {
  ...
  DEF_ROMLOC(162D6) : rom_1394();                   // JSR	$00001394
