...
ROMFUNC(rom_15E98) {
  ...
  DEF_ROMLOC(15E9A) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(15E9E)
      : move_toreg_16(read_16(0x15EA6 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(15EA2): goto rom_15EA6 + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(15EA2) : switch (switchindex) {
  case 0:
    rom_15EAC();
    break;
  case 1:
...
ROMFUNC(rom_15EAC) {
  ...
  DEF_ROMLOC(15F2A) : rom_15F96();                  // BRA.B	$15F96
}
ROMFUNC(rom_15F2A) {
  ...
  DEF_ROMLOC(15F92) : rom_FD38();                     // BRA.W	$FD38
}
ROMFUNC(rom_15F96) {
  DEF_ROMLOC(15F96)
      : move_toreg_16(read_16(0xFFFFFE04), &D0); // MOVE.W	$FE04,D0
  DEF_ROMLOC(15F9A)
      : and_toreg_16(read_16(A0 + 0x36), &D0);      // AND.W	54(A0),D0
  ...
  DEF_ROMLOC(15FC8) : animate_sprite();                     // JSR	$0000ADA2
  ...
  DEF_ROMLOC(16008) : rom_FD38();                     // BRA.W	$FD38
}