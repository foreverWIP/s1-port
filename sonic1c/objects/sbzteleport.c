...
ROMFUNC(rom_16DD0) {
  ...
  DEF_ROMLOC(16DD2) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(16DD6)
      : move_toreg_16(read_16(0x16E02 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	42(PC,D0),D1
  // DEF_ROMLOC(16DDA): rom_16E02 + (s16)(D1 & 0xffff)(); // JSR
  // 38(PC,D1)
  DEF_ROMLOC(16DDA) : switch (switchindex) {
  case 0:
    rom_16E0A();
    break;
  case 1:
...
ROMFUNC(rom_16E30) {
  ...
  DEF_ROMLOC(16E52) : sub_toreg_16(read_16(A0 + 0xC), &D1); // SUB.W
                                                            // 12(A0),D1
  ...
  DEF_ROMLOC(16E86)
      : move_tomem_16(0x800, A1 + 0x14); // MOVE.W
                                         // #$0800,20(A1)
  DEF_ROMLOC(16E8C)
      : move_tomem_16(0x0, A1 + 0x10); // MOVE.W	#$0000,16(A1)
  DEF_ROMLOC(16E92)
      : move_tomem_16(0x0, A1 + 0x12);              // MOVE.W	#$0000,18(A1)
  ...
  DEF_ROMLOC(16EBA) : move_toreg_16(SFX_ROLL, &D0);     // MOVE.W	#$00BE,D0
  DEF_ROMLOC(16EBE) : play_sound_special();         // JSR	$00001394
...
ROMFUNC(rom_16EC6) {
  ...
  DEF_ROMLOC(16EE4)
      : cmp_tomem_8(0xFFFFFF80, A0 + 0x32);        // CMPI.B	#$80,50(A0)
  ...
  DEF_ROMLOC(16EF4) : move_toreg_16(SFX_TELEPORT, &D0);    // MOVE.W	#$00BC,D0
  DEF_ROMLOC(16EF8) : play_sound_special();        // JSR	$00001394
  DEF_ROMLOC(16EFE) : return;                      // RTS
}
ROMFUNC(rom_16F00) {
  DEF_ROMLOC(16F00) : exit_early = true;              // TODO; // ADDQ.L	#$04,A7
  ...
  DEF_ROMLOC(16F32)
      : move_tomem_16(read_16((s32)A2 + (s8)0x0 + (s16)D1),
                      A0 + 0x36); // MOVE.W	0(A2,D1),54(A0)
  DEF_ROMLOC(16F38)
      : move_tomem_16(read_16((s32)A2 + (s8)0x2 + (s16)D1),
                      A0 + 0x38); // MOVE.W	2(A2,D1),56(A0)
  rom_16F84();
  return; // BRA.W	$16F84
  DEF_ROMLOC(16F42)
      : move_toreg_32(read_32(A1 + 0x8), &D2); // MOVE.L	8(A1),D2
  DEF_ROMLOC(16F46)
      : move_toreg_32(read_32(A1 + 0xC), &D3); // MOVE.L	12(A1),D3
  DEF_ROMLOC(16F4A)
...
ROMFUNC(rom_16F84) {
  ...
  DEF_ROMLOC(16FA2)
      : sub_toreg_16(read_16(A1 + 0xC), &D1);     // SUB.W	12(A1),D1
  ...
  DEF_ROMLOC(16FB2)
      : move_toreg_16(read_16(A0 + 0x38), &D1);             // MOVE.W	56(A0),D1
  DEF_ROMLOC(16FB6) : sub_toreg_16(read_16(A1 + 0xC), &D1); // SUB.W
                                                            // 12(A1),D1
