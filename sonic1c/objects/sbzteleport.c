...
ROMFUNC(rom_16E30) {
  ...
  DEF_ROMLOC(16E52)
      : sub_toreg_16(read_16(A0 + 0xC), &D1);         // SUB.W
                                                      // 12(A0),D1
...
ROMFUNC(rom_16EC6) {
  ...
  DEF_ROMLOC(16EF4)
      : move_toreg_16(SFX_TELEPORT, &D0);   // MOVE.W
                                            // #$00BC,D0
...
ROMFUNC(rom_16F00) {
  ...
  DEF_ROMLOC(16F1A)
      : move_toreg_8(read_8(A0 + 0x3A), &D1); // MOVE.B
                                              // 58(A0),D1
...
ROMFUNC(rom_16F84) {
  ...
  DEF_ROMLOC(16FB2)
      : move_toreg_16(read_16(A0 + 0x38), &D1); // MOVE.W	56(A0),D1
  DEF_ROMLOC(16FB6)
      : sub_toreg_16(read_16(A1 + 0xC), &D1);  // SUB.W
                                               // 12(A1),D1
  DEF_ROMLOC(16FBA) : SWAPWORDS(D1);           // SWAP.W	D1
  ...
  DEF_ROMLOC(16FCA) : SWAPWORDS(D0);                        // SWAP.W	D0
  ...
  DEF_ROMLOC(16FEC) : SWAPWORDS(D0);                        // SWAP.W	D0
  ...
  DEF_ROMLOC(16FFC) : SWAPWORDS(D1);                // SWAP.W	D1
