...
ROMFUNC(rom_15802) {
  ...
  DEF_ROMLOC(15804) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(15808)
      : move_toreg_16(read_16(0x15810 + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(1580C): goto rom_15810 + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(1580C) : switch (switchindex) {
  case 0:
    rom_15818();
    break;
  case 1:
...
ROMFUNC(rom_15818) {
  ...
  DEF_ROMLOC(1584C)
      : move_tomem_32(0x159FA, A1 + 0x4); // MOVE.L	#$000159FA,4(A1)
  DEF_ROMLOC(15854) : move_tomem_16(0x4348, A1 + 0x2); // MOVE.W
                                                       // #$4348,2(A1)
  DEF_ROMLOC(1585A) : or_tomem_8(0x4, A1 + 0x1);       // ORI.B	#$04,1(A1)
  DEF_ROMLOC(15860) : move_tomem_8(0x38, A1 + 0x19);   // MOVE.B	#$38,25(A1)
  DEF_ROMLOC(15866) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_15824;                                   // DBF.W	D1,$15824
  ...
  DEF_ROMLOC(15882)
      : move_tomem_8(read_8(A0 + 0x28), A0 + 0x38); // MOVE.B	40(A0),56(A0)
...
ROMFUNC(rom_15888) {
  ...
  DEF_ROMLOC(158C2)
      : cmp_toreg_8(read_8(A0 + 0x1A), &D1); // CMP.B	26(A0),D1
  DEF_ROMLOC(158C6) : if (!CCR_EQ) {
    rom_1591C();
    return;
  }                                                    // BNE.B	$1591C
  ...
  DEF_ROMLOC(158DC) : move_tomem_16(0x800, A1 + 0x14); // MOVE.W
                                                       // #$0800,20(A1)
  ...
  DEF_ROMLOC(15900)
      : move_toreg_16(read_16(A1 + 0x8), &D2); // MOVE.W	8(A1),D2
  DEF_ROMLOC(15904)
...
ROMFUNC(rom_15920) {
  ...
  DEF_ROMLOC(15930)
      : cmp_toreg_8(read_8(A0 + 0x32), &D0);           // CMP.B	50(A0),D0
  ...
  DEF_ROMLOC(15940) : move_tomem_16(0x800, A1 + 0x12); // MOVE.W
                                                       // #$0800,18(A1)
  DEF_ROMLOC(15946) : cmp_toreg_8(0x4, &D0);           // CMPI.B	#$04,D0
  DEF_ROMLOC(1594A) : if (CCR_EQ) goto rom_15958;      // BEQ.B	$15958
  DEF_ROMLOC(1594C) : move_tomem_16(0x800, A1 + 0x10); // MOVE.W
                                                       // #$0800,16(A1)
  DEF_ROMLOC(15952) : move_tomem_16(0x800, A1 + 0x12); // MOVE.W
                                                       // #$0800,18(A1)
...
ROMFUNC(rom_15968) {
  ...
  DEF_ROMLOC(1599C)
      : move_toreg_8(read_8(A0 + 0x34), &D1); // MOVE.B	52(A0),D1
  DEF_ROMLOC(159A0)
      : move_toreg_8(read_8(A0 + 0x1A), &D0);      // MOVE.B	26(A0),D0
...
ROMFUNC(rom_159B0) {
  ...
  DEF_ROMLOC(159BC)
      : move_toreg_32(0x159DA + (s16)(D0 & 0xffff),
                      &A2);                            // LEA.L	28(PC,D0),A2
