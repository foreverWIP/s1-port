...
ROMFUNC(rom_16760) {
  ...
  DEF_ROMLOC(16762) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(16766)
      : move_toreg_16(read_16(0x1676E + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	6(PC,D0),D1
  // DEF_ROMLOC(1676A): goto rom_1676E + (s16)(D1 & 0xffff); // JMP	2(PC,D1)
  DEF_ROMLOC(1676A) : switch (switchindex) {
  case 0:
    rom_16776();
    break;
  case 1:
...
ROMFUNC(rom_16776) {
  ...
  DEF_ROMLOC(1677A)
      : move_tomem_32(0x16892, A0 + 0x4); // MOVE.L	#$00016892,4(A0)
  DEF_ROMLOC(16782) : move_tomem_16(0x44C3, A0 + 0x2); // MOVE.W
                                                       // #$44C3,2(A0)
...
ROMFUNC(rom_167D0) {
  ...
  DEF_ROMLOC(167D4)
      : sub_toreg_16(read_16(A0 + 0x36), &D0); // SUB.W	54(A0),D0
  DEF_ROMLOC(167D8)
      : and_toreg_16(read_16(A0 + 0x38), &D0);     // AND.W	56(A0),D0
  ...
  DEF_ROMLOC(167EA) : animate_sprite();                  // JSR	$0000ADA2
  rom_FD38();                                      // BRA.W	$FD38
}
ROMFUNC(rom_167F4) {
  ...
  DEF_ROMLOC(16818) : animate_sprite();                     // JSR	$0000ADA2
