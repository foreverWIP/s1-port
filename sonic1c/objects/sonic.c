...
ROMFUNC(rom_133A2) {
  ...
  DEF_ROMLOC(13426) : move_toreg_16(COMSFX_SLOWDOWN, &D0);      // MOVE.W	#$00E3,D0
  DEF_ROMLOC(1342A) : {
    play_sound();
    return;
  }                           // JMP	$0000138E
...
ROMFUNC(rom_1B7AA) {
  ...
  DEF_ROMLOC(1B838) : move_toreg_16(SFX_HITSPIKES, &D0);       // MOVE.W	#$00A6,D0
...
ROMFUNC(rom_1B84E) {
  ...
  DEF_ROMLOC(1B898) : move_toreg_16(SFX_HITSPIKES, &D0);       // MOVE.W	#$00A6,D0
