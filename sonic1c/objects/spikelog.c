...
ROMFUNC(rom_8320) {
	...
	DEF_ROMLOC(8322): move_toreg_8(read_8(A0 + 0x24), &D0); switchindex = D0 / 2; // MOVE.B	36(A0),D0
	...
	DEF_ROMLOC(832A):
		switch (switchindex) {
			case 0: rom_8338(); break;
			case 1: rom_83FA(); break;
			case 2: rom_83FA(); break;
			case 3: rom_8468(); break;
			case 4: rom_846E(); break;
		}
}
ROMFUNC(rom_8338) {
	...
	DEF_ROMLOC(8384): if (CCR_CS) {rom_83FA();return;} // BCS.B	$83FA
	DEF_ROMLOC(8386): move_toreg_32(0x0, &D6); // MOVEQ.L	$00,D6
	DEF_ROMLOC(8388): rom_E11A(); // BSR.W	$E11A
	DEF_ROMLOC(838C): if (!CCR_EQ) {rom_83FA();return;} // BNE.B	$83FA
...
ROMFUNC(rom_8426) {
	...
	DEF_ROMLOC(8450): if (CCR_CS) {rom_8468();return;} // BCS.B	$8468
...
ROMFUNC(rom_846E) {
	...
	DEF_ROMLOC(8472): {rom_DC92();return;} // BRA.W	$DC92
