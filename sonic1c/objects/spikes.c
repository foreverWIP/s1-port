...
ROMFUNC(rom_D5E4) {
  ...
  DEF_ROMLOC(D5F2) : move_toreg_8(read_8(A0 + 0x34), &D0); // MOVE.B
                                                           // 52(A0),D0
  DEF_ROMLOC(D5F6)
  ...
  DEF_ROMLOC(D606) : move_toreg_8(read_8(A0 + 0x34), &D0);  // MOVE.B
                                                            // 52(A0),D0
  DEF_ROMLOC(D60A) : add_toreg_16(read_16(A0 + 0x30), &D0); // ADD.W
                                                            // 48(A0),D0
