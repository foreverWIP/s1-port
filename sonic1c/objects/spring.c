...
ROMFUNC(rom_E14C) {
  ...
  DEF_ROMLOC(E14E) : move_toreg_8(read_8(A0 + 0x24), &D0);
  switchindex = D0 / 2; // MOVE.B	36(A0),D0
  DEF_ROMLOC(E152)
      : move_toreg_16(read_16(0xE17E + (s16)(D0 & 0xffff)),
                      &D1); // MOVE.W	42(PC,D0),D1
  // DEF_ROMLOC(E156): rom_E17E + (s16)(D1 & 0xffff)(); // JSR	38(PC,D1)
  DEF_ROMLOC(E156) : switch (switchindex) {
  case 0:
    rom_E196();
    break;
  case 1:
...
ROMFUNC(rom_E196) {
  ...
  DEF_ROMLOC(E19A)
      : move_tomem_32(0xE3A8, A0 + 0x4);             // MOVE.L	#$0000E3A8,4(A0)
  ...
  DEF_ROMLOC(E1BA) : move_toreg_8(read_8(A0 + 0x28), &D0); // MOVE.B
                                                           // 40(A0),D0
  ...
  DEF_ROMLOC(E204)
      : move_tomem_16(read_16(0xE192 + (s16)(D0 & 0xffff)),
                      A0 + 0x30); // MOVE.W	-116(PC,D0),48(A0)
...
ROMFUNC(rom_E20C) {
  ...
  DEF_ROMLOC(E230)
      : move_tomem_16(read_16(A0 + 0x30), A1 + 0x12); // MOVE.W	48(A0),18(A1)
  ...
  DEF_ROMLOC(E258) : move_toreg_16(SFX_SPRING, &D0);        // MOVE.W	#$00CC,D0
  DEF_ROMLOC(E25C) : play_sound_special();            // JSR	$00001394
...
ROMFUNC(rom_E278) {
  ...
  DEF_ROMLOC(E2F0) : move_toreg_16(SFX_SPRING, &D0);        // MOVE.W	#$00CC,D0
  DEF_ROMLOC(E2F4) : play_sound_special();            // JSR	$00001394
...
ROMFUNC(rom_E310) {
  ...
  DEF_ROMLOC(E36C) : move_toreg_16(SFX_SPRING, &D0);        // MOVE.W	#$00CC,D0
  DEF_ROMLOC(E370) : play_sound_special();            // JSR	$00001394
