...
ROMFUNC(rom_19CA2) {
  ...
  DEF_ROMLOC(19CAE)
      : cmp_tomem_16(0x2D40, v_limitright2);            // CMPI.W
                                                        // #$2D40,$F72A
  DEF_ROMLOC(19CB4) : if (CCR_CC) goto rom_19CBC;       // BCC.B	$19CBC
  DEF_ROMLOC(19CB6) : add_tomem_16(0x2, v_limitright2); // ADDQ.W
                                                        // #$02,$F72A
