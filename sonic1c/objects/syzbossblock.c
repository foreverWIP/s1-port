...
ROMFUNC(rom_19E56) {
  ...
  DEF_ROMLOC(19E76) : move_tomem_16(0x4000, A1 + 0x2); // MOVE.W
                                                       // #$4000,2(A1)
...
ROMFUNC(rom_19EB4) {
  DEF_ROMLOC(19EB4)
      : move_toreg_8(read_8(A0 + 0x29), &D0); // MOVE.B	41(A0),D0
  DEF_ROMLOC(19EB8)
