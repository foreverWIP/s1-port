...
ROMFUNC(rom_1105C) {
  ...
  DEF_ROMLOC(110A2) : move_toreg_8(read_8(A0 + 0x22), &D0); // MOVE.B
                                                            // 34(A0),D0
...
ROMFUNC(rom_110B6) {
  ...
  DEF_ROMLOC(110B8) : move_toreg_8(read_8(A0 + 0x28), &D0); // MOVE.B
                                                            // 40(A0),D0
...
ROMFUNC(rom_1113C) {
  ...
  DEF_ROMLOC(11144) : move_toreg_8(read_8(A0 + 0x26), &D0); // MOVE.B
                                                            // 38(A0),D0
