...
ROMFUNC(rom_A49A) {
  ...
  DEF_ROMLOC(A4C4)
      : cmp_tomem_16(0x32, 0xFFFFFE20);             // CMPI.W	#$0032,$FE20
  ...
  DEF_ROMLOC(A4DE)
      : move_tomem_16(0xC40, 0xFFFFF7BE); // MOVE.W
                                          // #$0C40,$F7BE
...
ROMFUNC(rom_A50C) {
  ...
  DEF_ROMLOC(A51E) : move_tomem_8(OBJ_RINGFLASH, A1 + offsetof(object, id)); // MOVE.B	#$7C,0(A1)
  DEF_ROMLOC(A524)
