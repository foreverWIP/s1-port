...
void level_palette_cycle(void) {
  ...
  DEF_ROMLOC(1938) : move_toreg_8(read_8(v_zone), &D0);
...
void level_palette_cycle_lz(void) {
  ...
  DEF_ROMLOC(19AA) : cmp_tomem_8(0x3, v_act);        // CMPI.B	#$03,$FE11
...
void level_palette_cycle_sbz(void) {
  ...
  DEF_ROMLOC(1AC6) : tst_mem_8(v_act);               // TST.B	$FE11
  ...
  DEF_ROMLOC(1AE2)
      : move_tomem_8(read_8(A2++), A1++);            // MOVE.B
                                                     // (A2)+,(A1)+
  ...
  DEF_ROMLOC(1B14) : tst_mem_8(v_act);               // TST.B	$FE11
...
void palette_fade_in(bool full_palette) {
  if (full_palette) {
    DEF_ROMLOC(1DA4)
        : move_tomem_16(0x3F, 0xFFFFF626); // MOVE.W
                                           // #$003F,$F626
  }
...
void palette_move_from_black(void) {
  ...
  DEF_ROMLOC(1DF8) : cmp_tomem_8(ZONE_LZ, v_zone);   // CMPI.B	#$01,$FE10
...
void color_move_from_black(void) {
  ...
  DEF_ROMLOC(1E42)
      : add_tomem_16(0x2, (A0 += 2, A0 - 2)); // ADDQ.W
                                              // #$02,(A0)+
...
void palette_fade_out_runvblank(void) { end_frame(0x12); }
...
void palette_move_from_white(void) {
  ...
  DEF_ROMLOC(1F1E) : cmp_tomem_8(ZONE_LZ, v_zone);   // CMPI.B	#$01,$FE10
...
void color_move_from_white(void) {
  ...
  DEF_ROMLOC(1F6C)
      : sub_tomem_16(0x2, (A0 += 2, A0 - 2)); // SUBQ.W
                                              // #$02,(A0)+
