...
ROMFUNC(rom_45DE) {
  DEF_ROMLOC(45DE) : move_toreg_16(SFX_ENTERSS, &D0); // MOVE.W	#$00CA,D0
  DEF_ROMLOC(45E2) : play_sound_special();            // BSR.W	$1394
...
ROMFUNC(rom_45EA) {
  ...
  DEF_ROMLOC(4660) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_465E;                                         // DBF.W	D1,$465E
  DEF_ROMLOC(4664) : move_toreg_32(v_levelvariables, &A1); // LEA.L	$F700,A1
  ...
  DEF_ROMLOC(4670) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_466E;                                         // DBF.W	D1,$466E
  ...
  DEF_ROMLOC(4680) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_467E;                                         // DBF.W	D1,$467E
  ...
  DEF_ROMLOC(4690) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_468E;                            // DBF.W	D1,$468E
  ...
  DEF_ROMLOC(46A8)
      : move_tomem_32(0x0, v_screenposx);             // MOVE.L	#$00000000,$F700
  ...
  DEF_ROMLOC(46CC) : move_toreg_16(BGM_SS, &D0);      // MOVE.W	#$0089,D0
  DEF_ROMLOC(46D0) : play_sound();                    // BSR.W	$138E
  ...
  DEF_ROMLOC(46FA)
      : move_tomem_16(0x0, v_debuguse); // MOVE.W	#$0000,$FE08
  DEF_ROMLOC(4700)
...
ROMFUNC(rom_473A) {
  ...
  DEF_ROMLOC(474A) : build_sprites();           // JSR	$0000DCEC
  ...
  DEF_ROMLOC(4764) : if (CCR_EQ) {
    rom_4896();
    return;
  } // BEQ.W	$4896
  DEF_ROMLOC(4768) : DEF_ROMLOC(476E) : if (v_gamemode == GM_SPECIAL) {
    rom_472C();
    return;
  } // BEQ.W	$472C
  DEF_ROMLOC(4772) : tst_mem_16(0xFFFFFFF0); // TST.W	$FFF0
  DEF_ROMLOC(4776) : if (!CCR_EQ) {
    rom_489E();
    return;
  } // BNE.W	$489E
  DEF_ROMLOC(477A) : v_gamemode = GM_LEVEL;
  DEF_ROMLOC(4780)
      : cmp_tomem_16(ZONE16_SBZ | 3, v_zone);         // CMPI.W	#$0503,$FE10
  DEF_ROMLOC(4786) : if (CCR_CS) goto rom_478C;       // BCS.B	$478C
  DEF_ROMLOC(4788) : clr_mem_16(v_zone);              // CLR.W	$FE10
...
ROMFUNC(rom_47A6) {
  ...
  DEF_ROMLOC(47B6) : build_sprites();                // JSR	$0000DCEC
  ...
  DEF_ROMLOC(481C) : new_plc();                     // BSR.W	$15AA
  DEF_ROMLOC(4820) : move_toreg_32(0x1B, &D0);      // MOVEQ.L	$1B,D0
  DEF_ROMLOC(4822) : add_plc();                     // BSR.W	$1578
  ...
  DEF_ROMLOC(483E)
      : move_toreg_16(BGM_GOTTHROUGH, &D0);                // MOVE.W
                                                           // #$008E,D0
  DEF_ROMLOC(4842) : play_sound_special();                 // JSR	$00001394
  ...
  DEF_ROMLOC(4854) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_4852;                                   // DBF.W	D1,$4852
...
ROMFUNC(rom_486C) {
  ...
  DEF_ROMLOC(4872) : build_sprites();        // JSR	$0000DCEC
  DEF_ROMLOC(4878) : run_plc();              // BSR.W	$15E4
  DEF_ROMLOC(487C) : tst_mem_16(0xFFFFFE02); // TST.W	$FE02
  DEF_ROMLOC(4880) : if (CCR_EQ) {
    rom_485E();
    return;
  } // BEQ.B	$485E
  DEF_ROMLOC(4882) : tst_mem_32(v_plc_buffer); // TST.L	$F680
  DEF_ROMLOC(4886) : if (!CCR_EQ) {
    rom_485E();
    return;
  } // BNE.B	$485E
  DEF_ROMLOC(4888) : move_toreg_16(SFX_ENTERSS, &D0); // MOVE.W	#$00CA,D0
  DEF_ROMLOC(488C) : play_sound_special();            // BSR.W	$1394
  DEF_ROMLOC(4890) : game_state = rom_4894;
  palette_fade_to_white(); // BSR.W	$1F74
}
ROMFUNC(rom_4896) {
  DEF_ROMLOC(4896) : v_gamemode = GM_SEGA;
  DEF_ROMLOC(489C) : return; // RTS
}
ROMFUNC(rom_489E) {
  DEF_ROMLOC(48A4) : if (v_gamemode == GM_LEVEL) {
    rom_4896();
    return;
  } // BEQ.B	$4896
...
ROMFUNC(rom_48A8) {
  ...
  DEF_ROMLOC(48B8) : decompress_enigma();            // BSR.W	$1716
  ...
  copy_tilemap_to_vram(A1, D0, D2, D2);       // BSR.W	$1418
  DEF_ROMLOC(48FA) : D0 = d0backup;
  D1 = d1backup;
  D2 = d2backup;
  D3 = d3backup;
  D4 = d4backup;
...
ROMFUNC(rom_496E) {
  ...
  DEF_ROMLOC(49F4)
      : move_toreg_16(read_16(0xFFFFF79E), &D1);     // MOVE.W	$F79E,D1
  ...
  DEF_ROMLOC(4A1A)
      : move_tomem_32(read_32(A1),
                      (A2 += 4, A2 - 4)); // MOVE.L	(A1),(A2)+
  DEF_ROMLOC(4A1C)
      : move_tomem_32(read_32(A1 + 0x4),
                      (A2 += 4, A2 - 4)); // MOVE.L	4(A1),(A2)+
  DEF_ROMLOC(4A20)
      : move_tomem_32(read_32(A1 + 0x8),
                      (A2 += 4, A2 - 4));            // MOVE.L	8(A1),(A2)+
...
ROMFUNC(rom_4BF0) {
  DEF_ROMLOC(4BF0)
      : move_toreg_16(read_16(0xFFFFF7A0), &D0);     // MOVE.W	$F7A0,D0
  ...
  DEF_ROMLOC(4C24) : SWAPWORDS(D0);                  // SWAP.W	D0
  ...
  DEF_ROMLOC(4C42)
      : move_tomem_16(D0, (A3 += 2, A3 - 2));             // MOVE.W	D0,(A3)+
  ...
  DEF_ROMLOC(4C4A) : dec_reg_16(&D3);
  if ((D3 & 0xffff) != 0xffff)
    goto rom_4C32;                                    // DBF.W	D3,$4C32
  ...
  DEF_ROMLOC(4C74)
      : move_tomem_32(D0, (A3 += 4, A3 - 4));   // MOVE.L	D0,(A3)+
  DEF_ROMLOC(4C76) : sub_toreg_32(0x2000, &D2); // SUBI.L	#$00002000,D2
  DEF_ROMLOC(4C7C) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_4C70;                                   // DBF.W	D1,$4C70
  ...
  DEF_ROMLOC(4CA6)
      : move_toreg_16(read_16((A3 += 2, A3 - 2)), &D0); // MOVE.W	(A3)+,D0
  ...
  DEF_ROMLOC(4CB0)
      : move_tomem_32(D0,
                      (s32)A1 + (s8)0x0 + (s16)D2); // MOVE.L	D0,0(A1,D2)
  DEF_ROMLOC(4CB4) : add_toreg_16(0x4, &D2);        // ADDQ.W	#$04,D2
  DEF_ROMLOC(4CB6) : and_toreg_16(0x3FC, &D2);      // ANDI.W	#$03FC,D2
  DEF_ROMLOC(4CBA) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_4CB0; // DBF.W	D1,$4CB0
  DEF_ROMLOC(4CBE) : dec_reg_16(&D3);
  if ((D3 & 0xffff) != 0xffff)
    goto rom_4CA6;           // DBF.W	D3,$4CA6
...
ROMFUNC(rom_1BA46) {
  ...
  DEF_ROMLOC(1BA5E) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1BA5A;                                   // DBF.W	D1,$1BA5A
  DEF_ROMLOC(1BA62) : move_toreg_32(0xFF4005, &A1);   // LEA.L	$00FF4005,A1
  DEF_ROMLOC(1BA68) : sub_tomem_8(0x1, v_ani1_time);  // SUBQ.B	#$01,$FEC2
  DEF_ROMLOC(1BA6C) : if (CCR_PL) goto rom_1BA7E;     // BPL.B	$1BA7E
  DEF_ROMLOC(1BA6E) : move_tomem_8(0x7, v_ani1_time); // MOVE.B	#$07,$FEC2
  DEF_ROMLOC(1BA74) : add_tomem_8(0x1, v_ani1_frame); // ADDQ.B	#$01,$FEC3
  DEF_ROMLOC(1BA78) : and_tomem_8(0x3, v_ani1_frame); // ANDI.B	#$03,$FEC3
  DEF_ROMLOC(1BA7E)
      : move_tomem_8(read_8(v_ani1_frame),
                     A1 + 0x1D0);                     // MOVE.B	$FEC3,464(A1)
  DEF_ROMLOC(1BA84) : sub_tomem_8(0x1, v_ani2_time);  // SUBQ.B	#$01,$FEC4
  DEF_ROMLOC(1BA88) : if (CCR_PL) goto rom_1BA9A;     // BPL.B	$1BA9A
  DEF_ROMLOC(1BA8A) : move_tomem_8(0x7, v_ani2_time); // MOVE.B	#$07,$FEC4
  DEF_ROMLOC(1BA90) : add_tomem_8(0x1, v_ani2_frame); // ADDQ.B	#$01,$FEC5
  DEF_ROMLOC(1BA94) : and_tomem_8(0x1, v_ani2_frame); // ANDI.B	#$01,$FEC5
  DEF_ROMLOC(1BA9A)
      : move_toreg_8(read_8(v_ani2_frame), &D0);      // MOVE.B	$FEC5,D0
  ...
  DEF_ROMLOC(1BAC6) : sub_tomem_8(0x1, v_ani3_time);  // SUBQ.B	#$01,$FEC6
  DEF_ROMLOC(1BACA) : if (CCR_PL) goto rom_1BADC;     // BPL.B	$1BADC
  DEF_ROMLOC(1BACC) : move_tomem_8(0x4, v_ani3_time); // MOVE.B	#$04,$FEC6
  DEF_ROMLOC(1BAD2) : add_tomem_8(0x1, v_ani3_frame); // ADDQ.B	#$01,$FEC7
  DEF_ROMLOC(1BAD6) : and_tomem_8(0x3, v_ani3_frame); // ANDI.B	#$03,$FEC7
  DEF_ROMLOC(1BADC)
      : move_toreg_8(read_8(v_ani3_frame), &D0);      // MOVE.B	$FEC7,D0
  ...
  DEF_ROMLOC(1BAF0) : sub_tomem_8(0x1, v_ani0_time);  // SUBQ.B	#$01,$FEC0
  DEF_ROMLOC(1BAF4) : if (CCR_PL) goto rom_1BB06;     // BPL.B	$1BB06
  DEF_ROMLOC(1BAF6) : move_tomem_8(0x7, v_ani0_time); // MOVE.B	#$07,$FEC0
  DEF_ROMLOC(1BAFC) : sub_tomem_8(0x1, v_ani0_frame); // SUBQ.B	#$01,$FEC1
  DEF_ROMLOC(1BB00) : and_tomem_8(0x7, v_ani0_frame); // ANDI.B	#$07,$FEC1
  ...
  DEF_ROMLOC(1BB20)
      : move_tomem_16(read_16(A0 + 0x2), A1 + 0x8); // MOVE.W	2(A0),8(A1)
  DEF_ROMLOC(1BB26)
      : move_tomem_16(read_16(A0 + 0x4), A1 + 0x10); // MOVE.W	4(A0),16(A1)
  DEF_ROMLOC(1BB2C)
      : move_tomem_16(read_16(A0 + 0x6), A1 + 0x18); // MOVE.W	6(A0),24(A1)
  DEF_ROMLOC(1BB32)
      : move_tomem_16(read_16(A0 + 0x8), A1 + 0x20); // MOVE.W	8(A0),32(A1)
  DEF_ROMLOC(1BB38)
      : move_tomem_16(read_16(A0 + 0xA), A1 + 0x28); // MOVE.W	10(A0),40(A1)
  DEF_ROMLOC(1BB3E)
      : move_tomem_16(read_16(A0 + 0xC), A1 + 0x30); // MOVE.W	12(A0),48(A1)
  DEF_ROMLOC(1BB44)
      : move_tomem_16(read_16(A0 + 0xE), A1 + 0x38);  // MOVE.W	14(A0),56(A1)
...
ROMFUNC(rom_1BC70) {
  ...
  DEF_ROMLOC(1BC80) : dec_reg_16(&D0);
  if ((D0 & 0xffff) != 0xffff)
    goto rom_1BC7A;           // DBF.W	D0,$1BC7A
...
ROMFUNC(rom_1B954) {
  ...
  u16 d1backupinner = 0;
  u16 d2backup = 0;
  DEF_ROMLOC(1B954) : d0backupouter = D0;
  d1backupouter = D1;
  d2backup = D2;
  // TODO; // MOVEM.W	D0-D2,-(A7)
  DEF_ROMLOC(1B958) : d0backupinner = D0;
  d1backupinner = D1;
  ...
  DEF_ROMLOC(1B966) : D0 = (s32)((s16)d0backupinner);
  ...
  DEF_ROMLOC(1B986) : dec_reg_16(&D6);
  if ((D6 & 0xffff) != 0xffff)
    goto rom_1B976; // DBF.W	D6,$1B976
  DEF_ROMLOC(1B98A) : D0 = (s32)((s16)d0backupouter);
  ...
  DEF_ROMLOC(1B996)
      : move_toreg_16(read_16((A7 += 2, A7 - 2)), &D5); // MOVE.W	(A7)+,D5
...
ROMFUNC(rom_1B9C2) {
  ...
  DEF_ROMLOC(1BA00)
      : move_toreg_32((s32)A5 + (s8)0x0 + (s16)D0,
                      &A5); // LEA.L	0(A5,D0),A5
  DEF_ROMLOC(1BA04)
      : move_toreg_32(read_32((A5 += 4, A5 - 4)), &A1); // MOVEA.L	(A5)+,A1
  DEF_ROMLOC(1BA06)
      : move_toreg_16(read_16((A5 += 2, A5 - 2)), &D1); // MOVE.W	(A5)+,D1
  DEF_ROMLOC(1BA08) : add_toreg_16(D1, &D1);            // ADD.W	D1,D1
  DEF_ROMLOC(1BA0A)
      : add_toreg_16(read_16((s32)A1 + (s8)0x0 + (s16)D1),
                     &A1); // ADDA.W	0(A1,D1),A1
  DEF_ROMLOC(1BA0E)
      : move_toreg_16(read_16((A5 += 2, A5 - 2)), &A3); // MOVEA.W	(A5)+,A3
  ...
  DEF_ROMLOC(1BA18) : draw_normal_sprite();                       // JSR	$0000DDF0
  DEF_ROMLOC(1BA1E) : add_toreg_16(0x4, &A4);           // ADDQ.W	#$04,A4
  DEF_ROMLOC(1BA20) : dec_reg_16(&D6);
  if ((D6 & 0xffff) != 0xffff)
    goto rom_1B9C6;                                  // DBF.W	D6,$1B9C6
  DEF_ROMLOC(1BA24) : move_toreg_32(A0 + 0x70, &A0); // LEA.L	112(A0),A0
  DEF_ROMLOC(1BA28) : dec_reg_16(&D7);
  if ((D7 & 0xffff) != 0xffff)
    goto rom_1B9C2;                                 // DBF.W	D7,$1B9C2
...
ROMFUNC(rom_1BC90) {
  ...
  DEF_ROMLOC(1BC96) : switchindex = D0 - 1;
  lsl_toreg_16(0x2, &D0); // LSL.W	#$02,D0
  DEF_ROMLOC(1BC98)
      : move_toreg_32(read_32(0x1BCA2 + (s16)(D0 & 0xffff)),
                      &A1); // MOVEA.L	8(PC,D0),A1
  // DEF_ROMLOC(1BC9C): rom_A1(); // JSR	(A1)
  DEF_ROMLOC(1BC9C) : switch (switchindex) {
  case 0:
    rom_1BCBE();
    break;
  case 1:
  ...
  DEF_ROMLOC(1BCA0) : dec_reg_16(&D7);
  if ((D7 & 0xffff) != 0xffff)
    goto rom_1BC90;           // DBF.W	D7,$1BC90
...
ROMFUNC(rom_1BCBE) {
  ...
  DEF_ROMLOC(1BCCC)
      : move_toreg_8(read_8(A0 + 0x3), &D0);      // MOVE.B	3(A0),D0
  DEF_ROMLOC(1BCD0) : add_tomem_8(0x1, A0 + 0x3); // ADDQ.B	#$01,3(A0)
  DEF_ROMLOC(1BCD4)
      : move_toreg_32(read_32(A0 + 0x4), &A1); // MOVEA.L	4(A0),A1
  DEF_ROMLOC(1BCD8)
      : move_toreg_8(read_8(0x1BCE8 + (s16)(D0 & 0xffff)),
                     &D0);                         // MOVE.B	14(PC,D0),D0
...
ROMFUNC(rom_1BCE8) {
  ...
  DEF_ROMLOC(1BD04)
      : move_toreg_32(read_32(A0 + 0x4), &A1); // MOVEA.L	4(A0),A1
  DEF_ROMLOC(1BD08)
      : move_toreg_8(read_8(0x1BD1E + (s16)(D0 & 0xffff)),
                     &D0);                         // MOVE.B	20(PC,D0),D0
  ...
  DEF_ROMLOC(1BD1E)
      : move_toreg_16(read_16((s32)A3 + (s8)0x33 + (s16)D3),
                      &D1);                        // MOVE.W	51(A3,D3),D1
  ...
  DEF_ROMLOC(1BD3A)
      : move_toreg_32(read_32(A0 + 0x4), &A1); // MOVEA.L	4(A0),A1
  DEF_ROMLOC(1BD3E)
      : move_toreg_8(read_8(0x1BD4E + (s16)(D0 & 0xffff)),
                     &D0);                         // MOVE.B	14(PC,D0),D0
...
ROMFUNC(rom_1BD54) {
  ...
  DEF_ROMLOC(1BD6A)
      : move_toreg_32(read_32(A0 + 0x4), &A1); // MOVEA.L	4(A0),A1
  DEF_ROMLOC(1BD6E)
      : move_toreg_8(read_8(0x1BD84 + (s16)(D0 & 0xffff)),
                     &D0);                         // MOVE.B	20(PC,D0),D0
...
ROMFUNC(rom_1BD84) {
  DEF_ROMLOC(1BD84)
      : move_tomem_32(read_32((s32)A1 + (s8)0x31 + (s16)D2),
                      A5 -= 4);                    // MOVE.L	49(A1,D2),-(A5)
  ...
  DEF_ROMLOC(1BDA0)
      : move_toreg_32(read_32(A0 + 0x4), &A1); // MOVEA.L	4(A0),A1
  DEF_ROMLOC(1BDA4)
      : move_toreg_8(read_8(0x1BDC4 + (s16)(D0 & 0xffff)),
  ...
  DEF_ROMLOC(1BDB8) : move_toreg_16(SFX_SSGOAL, &D0); // MOVE.W	#$00A8,D0
  DEF_ROMLOC(1BDBC) : play_sound_special();           // JSR	$00001394
...
ROMFUNC(rom_1BE32) {
  ...
  DEF_ROMLOC(1BE60)
      : cmp_toreg_8(read_8((s32)A3 + (s8)0x0 + (s16)D1),
                    &D0);                          // CMP.B	0(A3,D1),D0
  DEF_ROMLOC(1BE64) : if (!CCR_EQ) goto rom_1BE68; // BNE.B	$1BE68
  goto rom_1BE32;                                  // BRA.B	$1BE32
  DEF_ROMLOC(1BE68) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1BE60;                           // DBF.W	D1,$1BE60
  DEF_ROMLOC(1BE6C) : lsl_toreg_16(0x2, &D0); // LSL.W	#$02,D0
  DEF_ROMLOC(1BE6E)
      : move_toreg_32(0x1BE1A + (s16)(D0 & 0xffff),
                      &A1); // LEA.L	-86(PC,D0),A1
  DEF_ROMLOC(1BE72)
      : move_tomem_16(read_16((A1 += 2, A1 - 2)),
                      0xFFFFD008); // MOVE.W	(A1)+,$D008
  DEF_ROMLOC(1BE76)
      : move_tomem_16(read_16((A1 += 2, A1 - 2)),
                      0xFFFFD00C); // MOVE.W	(A1)+,$D00C
  DEF_ROMLOC(1BE7A)
      : move_toreg_32(read_32(0x1BE02 + (s16)(D0 & 0xffff)),
                      &A0);                         // MOVEA.L	-122(PC,D0),A0
  DEF_ROMLOC(1BE7E) : move_toreg_32(0xFF4000, &A1); // LEA.L	$00FF4000,A1
  DEF_ROMLOC(1BE84) : move_toreg_16(0x0, &D0);      // MOVE.W	#$0000,D0
  DEF_ROMLOC(1BE88) : decompress_enigma();          // JSR	$00001716
...
ROMFUNC(rom_1BE98) {
  ...
  DEF_ROMLOC(1BE9A) : dec_reg_16(&D0);
  if ((D0 & 0xffff) != 0xffff)
    goto rom_1BE98;                                 // DBF.W	D0,$1BE98
...
ROMFUNC(rom_1BEAC) {
  ...
  DEF_ROMLOC(1BEAE)
      : move_tomem_8(read_8(A0++), A1++); // MOVE.B
                                          // (A0)+,(A1)+
  DEF_ROMLOC(1BEB0) : dec_reg_16(&D2);
  if ((D2 & 0xffff) != 0xffff)
    goto rom_1BEAE;                                  // DBF.W	D2,$1BEAE
  DEF_ROMLOC(1BEB4) : move_toreg_32(A1 + 0x40, &A1); // LEA.L	64(A1),A1
  DEF_ROMLOC(1BEB8) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1BEAC;                                 // DBF.W	D1,$1BEAC
  ...
  DEF_ROMLOC(1BECC)
      : move_tomem_16(0x0, (A1 += 2, A1 - 2)); // MOVE.W	#$0000,(A1)+
  DEF_ROMLOC(1BED0)
      : move_tomem_8(read_8(A0 - 0x4), A1 - 0x1); // MOVE.B	-4(A0),-1(A1)
  DEF_ROMLOC(1BED6)
      : move_tomem_16(read_16((A0 += 2, A0 - 2)),
                      (A1 += 2, A1 - 2)); // MOVE.W	(A0)+,(A1)+
  DEF_ROMLOC(1BED8) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1BECA;                                 // DBF.W	D1,$1BECA
...
ROMFUNC(rom_1BEE6) {
  ...
  DEF_ROMLOC(1BEE8) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1BEE6;           // DBF.W	D1,$1BEE6
...
ROMFUNC(rom_1C396) {
  DEF_ROMLOC(1C396)
      : add_tomem_16(0x40, 0xFFFFF782); // ADDI.W	#$0040,$F782
  DEF_ROMLOC(1C39C)
      : cmp_tomem_16(0x1800, 0xFFFFF782);          // CMPI.W
                                                   // #$1800,$F782
  DEF_ROMLOC(1C3A2) : if (!CCR_EQ) goto rom_1C3AA; // BNE.B	$1C3AA
  DEF_ROMLOC(1C3A4) : v_gamemode = GM_LEVEL;
  DEF_ROMLOC(1C3AA)
      : cmp_tomem_16(0x3000, 0xFFFFF782);         // CMPI.W
                                                  // #$3000,$F782
  DEF_ROMLOC(1C3B0) : if (CCR_LT) goto rom_1C3C8; // BLT.B	$1C3C8
  DEF_ROMLOC(1C3B2)
      : move_tomem_16(0x0, 0xFFFFF782); // MOVE.W	#$0000,$F782
  DEF_ROMLOC(1C3B8)
      : move_tomem_16(0x4000, 0xFFFFF780);         // MOVE.W
                                                   // #$4000,$F780
...
ROMFUNC(rom_1C3EA) {
  ...
  DEF_ROMLOC(1C3F0) : v_gamemode = GM_LEVEL;
...
ROMFUNC(rom_1C40C) {
  ...
  DEF_ROMLOC(1C422)
      : move_toreg_16(read_16(A0 + 0x10), &D4); // MOVE.W	16(A0),D4
  ...
  DEF_ROMLOC(1C430)
      : move_toreg_16(read_16(A0 + 0x12), &D4);     // MOVE.W	18(A0),D4
...
ROMFUNC(rom_1C49E) {
  ...
  DEF_ROMLOC(1C4A6) : SWAPWORDS(D2);                   // SWAP.W	D2
  ...
  DEF_ROMLOC(1C4BC) : SWAPWORDS(D3);                   // SWAP.W	D3
...
ROMFUNC(rom_1C508) {
  ...
  DEF_ROMLOC(1C570)
      : move_toreg_16(SFX_CONTINUE, &D0);           // MOVE.W
                                                    // #$00BF,D0
  DEF_ROMLOC(1C574) : play_sound();                 // JSR	$0000138E
  ...
  DEF_ROMLOC(1C592) : add_tomem_8(0x1, v_lives);    // ADDQ.B	#$01,$FE12
  DEF_ROMLOC(1C596) : add_tomem_8(0x1, 0xFFFFFE1C); // ADDQ.B	#$01,$FE1C
  DEF_ROMLOC(1C59A)
      : move_toreg_16(BGM_EXTRALIFE, &D0);          // MOVE.W
                                                    // #$0088,D0
  DEF_ROMLOC(1C59E) : play_sound();                 // JSR	$0000138E
  ...
  DEF_ROMLOC(1C5D8)
      : move_tomem_8(D4,
                     (s32)A2 + (s8)0x0 + (s16)D0);  // MOVE.B	D4,0(A2,D0)
  DEF_ROMLOC(1C5DC) : add_tomem_8(0x1, 0xFFFFFE57); // ADDQ.B	#$01,$FE57
  DEF_ROMLOC(1C5E0)
      : move_toreg_16(BGM_EMERALD, &D0);              // MOVE.W
                                                      // #$0093,D0
  DEF_ROMLOC(1C5E4) : play_sound_special();           // JSR	$00001394
  ...
  DEF_ROMLOC(1C630) : dec_reg_16(&D2);
  if ((D2 & 0xffff) != 0xffff)
    goto rom_1C624;                                  // DBF.W	D2,$1C624
  DEF_ROMLOC(1C634) : move_toreg_32(A1 + 0x40, &A1); // LEA.L	64(A1),A1
  DEF_ROMLOC(1C638) : dec_reg_16(&D1);
  if ((D1 & 0xffff) != 0xffff)
    goto rom_1C622;                            // DBF.W	D1,$1C622
...
ROMFUNC(rom_1C644) {
  DEF_ROMLOC(1C644)
      : move_toreg_8(read_8(A0 + 0x30), &D0);       // MOVE.B	48(A0),D0
  ...
  DEF_ROMLOC(1C66A)
      : move_toreg_32(read_32(A0 + 0x32), &D1);    // MOVE.L	50(A0),D1
  ...
  DEF_ROMLOC(1C694)
      : sub_toreg_16(read_16(A0 + 0xC), &D2);         // SUB.W
                                                      // 12(A0),D2
  ...
  DEF_ROMLOC(1C6C8)
      : move_toreg_32(read_32(A0 + 0x32), &D0);       // MOVE.L	50(A0),D0
  DEF_ROMLOC(1C6CC) : sub_toreg_32(0x1, &D0);         // SUBQ.L	#$01,D0
  DEF_ROMLOC(1C6CE) : move_tomem_32(D0, A2 + 0x4);    // MOVE.L	D0,4(A2)
  DEF_ROMLOC(1C6D2) : move_toreg_16(SFX_BUMPER, &D0); // MOVE.W	#$00B4,D0
  DEF_ROMLOC(1C6D6) : play_sound_special();
  return;                                             // JMP	$00001394
  ...
  DEF_ROMLOC(1C6E6) : move_toreg_16(SFX_SSGOAL, &D0); // MOVE.W	#$00A8,D0
  DEF_ROMLOC(1C6EA) : play_sound_special();           // JSR	$00001394
  ...
  DEF_ROMLOC(1C712)
      : move_toreg_32(read_32(A0 + 0x32), &A1);       // MOVEA.L	50(A0),A1
  DEF_ROMLOC(1C716) : sub_toreg_32(0x1, &A1);         // SUBQ.L	#$01,A1
  DEF_ROMLOC(1C718) : move_tomem_8(0x2A, A1);         // MOVE.B	#$2A,(A1)
  DEF_ROMLOC(1C71C) : move_toreg_16(SFX_SSITEM, &D0); // MOVE.W	#$00A9,D0
  DEF_ROMLOC(1C720) : play_sound_special();
  return;                                            // JMP	$00001394
  ...
  DEF_ROMLOC(1C750) : move_toreg_16(SFX_SSITEM, &D0); // MOVE.W	#$00A9,D0
  DEF_ROMLOC(1C754) : play_sound_special();
  return;                                            // JMP	$00001394
  ...
  DEF_ROMLOC(1C786) : move_toreg_16(SFX_SSITEM, &D0); // MOVE.W	#$00A9,D0
  DEF_ROMLOC(1C78A) : play_sound_special();
  return;                                          // JMP	$00001394
  ...
  DEF_ROMLOC(1C7CC)
      : move_toreg_16(SFX_SSGLASS, &D0); // MOVE.W
                                         // #$00BA,D0
  DEF_ROMLOC(1C7D0) : play_sound_special();
  return;                     // JMP	$00001394
