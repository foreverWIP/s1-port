...
ROMFUNC(rom_3076) {
  ...
  DEF_ROMLOC(30EA) : move_tomem_16(0x178, 0xFFFFF614); // MOVE.W
                                                       // #$0178,$F614
...
ROMFUNC(rom_327C) {
  ...
  DEF_ROMLOC(328A)
      : and_tomem_8(0xFFFFFFF0, 0xFFFFF605); // ANDI.B	#$F0,$F605
  ...
  DEF_ROMLOC(32CE) : move_tomem_16(0x600, 0xFFFFFE10); // MOVE.W
                                                       // #$0600,$FE10
