...
ROMFUNC(rom_2F04) {
  ...
  DEF_ROMLOC(2FB8) : build_sprites();         // JSR	$0000DCEC
...
ROMFUNC(rom_301A) {
  DEF_ROMLOC(301A) : write_vdp_data_16(read_16((A5 += 2, A5 - 2)));
...
ROMFUNC(rom_3076) {
  ...
  DEF_ROMLOC(3134) : build_sprites();                // JSR	$0000DCEC
...
ROMFUNC(rom_3168) {
  ...
  DEF_ROMLOC(3172) : build_sprites();               // JSR	$0000DCEC
