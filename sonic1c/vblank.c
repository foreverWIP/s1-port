...
ROMFUNC(rom_B10) {
  ...
  DEF_ROMLOC(B1A)
      : move_toreg_16(read_vdp_control_16(),
                      &D0); // MOVE.W	$00C00004,D0
  DEF_ROMLOC(B20)
...
ROMFUNC(rom_B88) {
  ...
  DEF_ROMLOC(BDE) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(BE4) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(BEA) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(BFE)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(C04) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(C0A) : write_vdp_control_32(0x96FD9540);
  DEF_ROMLOC(C10) : write_vdp_control_16(0x977F);
...
ROMFUNC(rom_C6E) {
  ...
  DEF_ROMLOC(C8A)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(C90) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(C96) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(C9C) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(CB0)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(CB6) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(CBC) : write_vdp_control_32(0x96FD9540);
  DEF_ROMLOC(CC2) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(CD8)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(CDE) : write_vdp_control_32(0x940193C0);
  DEF_ROMLOC(CE4) : write_vdp_control_32(0x96E69500);
  DEF_ROMLOC(CEA) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(CFC)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(D02) : write_vdp_control_32(0x94019340);
  DEF_ROMLOC(D08) : write_vdp_control_32(0x96FC9500);
  DEF_ROMLOC(D0E) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(D26)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(D2C) : write_vdp_control_32(0x94019370);
  DEF_ROMLOC(D32) : write_vdp_control_32(0x96E49500);
  DEF_ROMLOC(D38) : write_vdp_control_16(0x977F);
...
ROMFUNC(rom_DA6) {
  ...
  DEF_ROMLOC(DBC)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(DC2) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(DC8) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(DCE) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(DE0)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(DE6) : write_vdp_control_32(0x94019340);
  DEF_ROMLOC(DEC) : write_vdp_control_32(0x96FC9500);
  DEF_ROMLOC(DF2) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(E04)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(E0A) : write_vdp_control_32(0x940193C0);
  DEF_ROMLOC(E10) : write_vdp_control_32(0x96E69500);
  DEF_ROMLOC(E16) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(E3A)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(E40) : write_vdp_control_32(0x94019370);
  DEF_ROMLOC(E46) : write_vdp_control_32(0x96E49500);
  DEF_ROMLOC(E4C) : write_vdp_control_16(0x977F);
...
ROMFUNC(rom_E72) {
  ...
  DEF_ROMLOC(E8E)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(E94) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(E9A) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(EA0) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(EB4)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(EBA) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(EC0) : write_vdp_control_32(0x96FD9540);
  DEF_ROMLOC(EC6) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(EDC)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(EE2) : write_vdp_control_32(0x940193C0);
  DEF_ROMLOC(EE8) : write_vdp_control_32(0x96E69500);
  DEF_ROMLOC(EEE) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(F00)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(F06) : write_vdp_control_32(0x94019340);
  DEF_ROMLOC(F0C) : write_vdp_control_32(0x96FC9500);
  DEF_ROMLOC(F12) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(F2A)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(F30) : write_vdp_control_32(0x94019370);
  DEF_ROMLOC(F36) : write_vdp_control_32(0x96E49500);
  DEF_ROMLOC(F3C) : write_vdp_control_16(0x977F);
...
ROMFUNC(rom_FA6) {
  ...
  DEF_ROMLOC(FBC)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(FC2) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(FC8) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(FCE) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(FE0)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);        // LEA.L	$00C00004,A5
  DEF_ROMLOC(FE6) : write_vdp_control_32(0x94019340);
  DEF_ROMLOC(FEC) : write_vdp_control_32(0x96FC9500);
  DEF_ROMLOC(FF2) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(1004)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(100A) : write_vdp_control_32(0x940193C0);
  DEF_ROMLOC(1010) : write_vdp_control_32(0x96E69500);
  DEF_ROMLOC(1016) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(1036)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(103C) : write_vdp_control_32(0x94019370);
  DEF_ROMLOC(1042) : write_vdp_control_32(0x96E49500);
  DEF_ROMLOC(1048) : write_vdp_control_16(0x977F);
...
ROMFUNC(rom_106E) {
  ...
  DEF_ROMLOC(108A)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(1090) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(1096) : write_vdp_control_32(0x96FD9580);
  DEF_ROMLOC(109C) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(10B0)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(10B6) : write_vdp_control_32(0x94009340);
  DEF_ROMLOC(10BC) : write_vdp_control_32(0x96FD9540);
  DEF_ROMLOC(10C2) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(10D4)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(10DA) : write_vdp_control_32(0x94019340);
  DEF_ROMLOC(10E0) : write_vdp_control_32(0x96FC9500);
  DEF_ROMLOC(10E6) : write_vdp_control_16(0x977F);
  ...
  DEF_ROMLOC(10F8)
      : move_toreg_32(VDP_CONTROL_PORT, &A5);         // LEA.L	$00C00004,A5
  DEF_ROMLOC(10FE) : write_vdp_control_32(0x940193C0);
  DEF_ROMLOC(1104) : write_vdp_control_32(0x96E69500);
  DEF_ROMLOC(110A) : write_vdp_control_16(0x977F);
