...
ROMFUNC(rom_1C7DA) {
  ...
  DEF_ROMLOC(1C7EC) : move_toreg_8(read_8(0xFFFFFE10), &D0);
...
ROMFUNC(rom_1C80A) {
  ...
  DEF_ROMLOC(1C82E)
      : move_tomem_32(0x6F000001, 0xC00004);   // MOVE.L	#$6F000001,$00C00004
  ...
  DEF_ROMLOC(1C864)
      : move_tomem_32(0x6B800001, 0xC00004);   // MOVE.L	#$6B800001,$00C00004
  ...
  DEF_ROMLOC(1C8A6)
      : move_tomem_32(0x6D800001, 0xC00004); // MOVE.L	#$6D800001,$00C00004
...
ROMFUNC(rom_1C8C8) {
  ...
  DEF_ROMLOC(1C8F4)
      : move_tomem_32(0x5C400001, 0xC00004);   // MOVE.L	#$5C400001,$00C00004
  ...
  DEF_ROMLOC(1C922)
      : move_tomem_32(0x5A400001, 0xC00004);   // MOVE.L	#$5A400001,$00C00004
  ...
  DEF_ROMLOC(1C98E)
      : move_tomem_32(0x5E400001, 0xC00004);   // MOVE.L	#$5E400001,$00C00004
...
ROMFUNC(rom_1C9A2) {
  ...
  DEF_ROMLOC(1C9C0)
      : move_tomem_32(0x49000002, 0xC00004); // MOVE.L	#$49000002,$00C00004
  DEF_ROMLOC(1C9CA)
      : move_toreg_8(read_8(0xFFFFF7B0), &D0);      // MOVE.B	$F7B0,D0
  ...
  DEF_ROMLOC(1CA24)
      : move_tomem_32(0x4A800002, 0xC00004); // MOVE.L	#$4A800002,$00C00004
  DEF_ROMLOC(1CA2E)
      : move_toreg_8(read_8(0xFFFFF7B2), &D0);      // MOVE.B	$F7B2,D0
...
ROMFUNC(rom_1CA58) {
  ...
  DEF_ROMLOC(1CA6A) : move_toreg_32(v_256x256 + 0xA400 - 0x1000, &A2); // LEA.L	$9400,A2
  DEF_ROMLOC(1CA6E)
      : move_toreg_8(read_8(0xFFFFF7B2), &D0);        // MOVE.B	$F7B2,D0
  ...
  DEF_ROMLOC(1CA98)
      : move_tomem_32(0x72000001, 0xC00004);   // MOVE.L	#$72000001,$00C00004
...
ROMFUNC(rom_1CAAA) {
  ...
  DEF_ROMLOC(1CB12)
      : move_tomem_32(0x70000001, 0xC00004); // MOVE.L	#$70000001,$00C00004
  DEF_ROMLOC(1CB1C) : move_toreg_32(v_256x256 + 0xA400 - 0xC000, &A1); // LEA.L	$9800,A1
  DEF_ROMLOC(1CB20)
      : move_toreg_32((s32)A1 + (s8)0x0 + (s16)D0,
                      &A1);                    // LEA.L	0(A1,D0),A1
...
ROMFUNC(rom_1CB30) {
  ...
  DEF_ROMLOC(1CB50)
      : move_tomem_32(0x68000001, 0xC00004); // MOVE.L	#$68000001,$00C00004
  DEF_ROMLOC(1CB5A) : move_toreg_32(v_256x256 + 0xA400 - 0x600, &A1); // LEA.L	$9E00,A1
  DEF_ROMLOC(1CB5E)
      : move_toreg_32((s32)A1 + (s8)0x0 + (s16)D0,
                      &A1);                    // LEA.L	0(A1,D0),A1
...
ROMFUNC(rom_1CBC6) {
  DEF_ROMLOC(1CBC6)
      : move_tomem_32(read_32(A1 + 0x2), A6);        // MOVE.L	2(A1),(A6)
...
ROMFUNC(rom_1CBD4) {
  ...
  DEF_ROMLOC(1CBD8)
      : move_toreg_8(read_8(A1 + 0x3), &D0);         // MOVE.B	3(A1),D0
...
ROMFUNC(rom_1CBEA) {
  DEF_ROMLOC(1CBEA)
      : move_tomem_32(read_32(A1 + 0x4), A6);        // MOVE.L	4(A1),(A6)
...
ROMFUNC(rom_1CBF8) {
  ...
  DEF_ROMLOC(1CBFC)
      : move_toreg_8(read_8(A1 + 0x5), &D0);         // MOVE.B	5(A1),D0
...
ROMFUNC(rom_1CC0E) {
  DEF_ROMLOC(1CC0E)
      : move_tomem_32(read_32(A1 + 0x6), A6);        // MOVE.L	6(A1),(A6)
...
ROMFUNC(rom_1CC1C) {
  ...
  DEF_ROMLOC(1CC20)
      : move_toreg_8(read_8(A1 + 0x7), &D0);         // MOVE.B	7(A1),D0
...
ROMFUNC(rom_1CC32) {
  DEF_ROMLOC(1CC32)
      : move_tomem_32(read_32(A1 + 0x8), A6);        // MOVE.L	8(A1),(A6)
...
ROMFUNC(rom_1CC40) {
  ...
  DEF_ROMLOC(1CC44)
      : move_toreg_8(read_8(A1 + 0x9), &D0);         // MOVE.B	9(A1),D0
...
ROMFUNC(rom_1CC56) {
  DEF_ROMLOC(1CC56)
      : move_tomem_32(read_32(A1 + 0xA), A6);        // MOVE.L	10(A1),(A6)
...
ROMFUNC(rom_1CC64) {
  ...
  DEF_ROMLOC(1CC68)
      : move_toreg_8(read_8(A1 + 0xB), &D0);         // MOVE.B	11(A1),D0
...
ROMFUNC(rom_1CC7A) {
  DEF_ROMLOC(1CC7A)
      : move_tomem_32(read_32(A1 + 0xC), A6);        // MOVE.L	12(A1),(A6)
...
ROMFUNC(rom_1CC88) {
  ...
  DEF_ROMLOC(1CC8E)
      : move_toreg_8(read_8(A1 + 0x0), &D0);         // MOVE.B	0(A1),D0
...
ROMFUNC(rom_1CC9E) {
  DEF_ROMLOC(1CC9E)
      : move_tomem_16(read_16(A1 + 0xE), A6); // MOVE.W	14(A1),(A6)
  DEF_ROMLOC(1CCA2)
      : move_tomem_16(read_16(A1 + 0x0), A6);        // MOVE.W	0(A1),(A6)
...
ROMFUNC(rom_1CCB0) {
  ...
  DEF_ROMLOC(1CCB4)
      : move_toreg_8(read_8(A1 + 0xF), &D0);         // MOVE.B	15(A1),D0
...
ROMFUNC(rom_1CCC6) {
  ...
  DEF_ROMLOC(1CCCE) : sub_tomem_16(0x1C0, 0xFFFFF7BE); // SUBI.W
                                                       // #$01C0,$F7BE
