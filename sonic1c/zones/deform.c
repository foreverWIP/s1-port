...
ROMFUNC(rom_61AA) {
  ...
  DEF_ROMLOC(61C6) : move_toreg_8(read_8(0xFFFFFE10), &D2);
...
ROMFUNC(rom_626E) {
  ...
  DEF_ROMLOC(62A0) : move_toreg_8(read_8(0xFFFFFE10), &D0);
...
ROMFUNC(rom_63B6) {
  ...
  DEF_ROMLOC(6432)
      : move_tomem_16(D4, (A1 += 2, A1 - 2)); // MOVE.W	D4,(A1)+
  DEF_ROMLOC(6434)
