...
ROMFUNC(rom_3D1A) {
  ...
  DEF_ROMLOC(3D4E) : move_toreg_16(SFX_RUMBLING, &D0);        // MOVE.W	#$00B7,D0
...
ROMFUNC(rom_3E34) {
  ...
  DEF_ROMLOC(3E88) : move_toreg_16(SPECSFX_WATERFALL, &D0);              // MOVE.W	#$00D0,D0
...
ROMFUNC(rom_3F36) {
  ...
  DEF_ROMLOC(3FB6) : move_toreg_16(SPECSFX_WATERFALL, &D0);   // MOVE.W	#$00D0,D0
