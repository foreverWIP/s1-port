...
ROMFUNC(rom_3D1A) {
  ...
  DEF_ROMLOC(3D2E)
      : cmp_tomem_16(0x3C0, 0xFFFFD00C);        // CMPI.W	#$03C0,$D00C
  DEF_ROMLOC(3D34) : if (CCR_CS) goto rom_3D56; // BCS.B	$3D56
  DEF_ROMLOC(3D36)
      : cmp_tomem_16(0x600, 0xFFFFD00C);             // CMPI.W	#$0600,$D00C
  ...
  DEF_ROMLOC(3D4E)
      : move_toreg_16(SFX_RUMBLING, &D0);           // MOVE.W
                                                    // #$00B7,D0
  DEF_ROMLOC(3D52) : play_sound_special();          // BSR.W	$1394
  ...
  DEF_ROMLOC(3DF2)
      : move_tomem_16(0x608, 0xFFFFF64A); // MOVE.W
                                          // #$0608,$F64A
  DEF_ROMLOC(3DF8)
      : move_tomem_16(0x7C0, 0xFFFFF648);           // MOVE.W
                                                    // #$07C0,$F648
  ...
  DEF_ROMLOC(3E16)
      : move_tomem_16(0x128, 0xFFFFF64A); // MOVE.W
                                          // #$0128,$F64A
...
ROMFUNC(rom_3E1E) {
  ...
  DEF_ROMLOC(3E22)
      : cmp_tomem_16(0xF00, v_screenposx);          // CMPI.W	#$0F00,$F700
...
ROMFUNC(rom_3E34) {
  DEF_ROMLOC(3E34) : tst_mem_16(v_debuguse);           // TST.W	$FE08
  ...
  DEF_ROMLOC(3E88) : move_toreg_16(SPECSFX_WATERFALL, &D0); // MOVE.W
                                                            // #$00D0,D0
  DEF_ROMLOC(3E8C) : play_sound_special();                  // JSR	$00001394
...
ROMFUNC(rom_3F36) {
  ...
  DEF_ROMLOC(3FB6)
      : move_toreg_16(SPECSFX_WATERFALL, &D0); // MOVE.W
                                               // #$00D0,D0
  DEF_ROMLOC(3FBA) : play_sound_special();     // JSR	$00001394
