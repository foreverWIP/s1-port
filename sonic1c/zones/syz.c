...
ROMFUNC(rom_6710) {
  ...
  DEF_ROMLOC(6752) : SWAPWORDS(D3);                        // SWAP.W	D3
  DEF_ROMLOC(6754) : add_toreg_32(D0, &D3);                // ADD.L	D0,D3
  DEF_ROMLOC(6756) : SWAPWORDS(D3);                        // SWAP.W	D3
  ...
  DEF_ROMLOC(679A) : SWAPWORDS(D3);                        // SWAP.W	D3
  DEF_ROMLOC(679C) : add_toreg_32(D0, &D3);                // ADD.L	D0,D3
  DEF_ROMLOC(679E) : SWAPWORDS(D3);                        // SWAP.W	D3
